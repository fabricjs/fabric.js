...
export function commonEventInfo(eventData, transform, x, y) {
  return {
    e: eventData,
    transform: transform,
    pointer: {
 ...
 * @private
 */
export function compensateScaleForSkew(target, oppositeSkew, scaleToCompensate, axis, reference) {
 ...
 * @private
 */
export function rotateWithSnapping(eventData, transform, x, y) {
  var t = transform,
    target = t.target,
 ...
 * @return {Boolean} true if some change happened
 */
export function changeObjectWidth(eventData, transform, x, y) {
 ...
 */
export function dragHandler(eventData, transform, x, y) {
  var target = transform.target,
...
export const rotationWithSnapping = wrapWithFireEvent('rotating', wrapWithFixedAnchor(rotateWithSnapping));
