  ...
  implements StaticCanvasOptions
{
   ...
   * @param {Promise<FabricObject> | void} [reviver] Method for further parsing of JSON elements, called after each fabric object created with the instance
   * if creation was successfully or with defined error if not. If a FabricObject is returned in the reviver, this instance will be used in place of that one witch generated error.
