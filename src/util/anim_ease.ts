 ...
 */
export const defaultEasing: EasingFunction = (t, b, c, d) =>
 ...
 * @memberOf fabric.util.ease
 */
export const easeInBack: EasingFunction = (t, b, c, d, s = 1.70158) =>
  c * (t /= d) * t * ((s + 1) * t - s) + b;
 ...
 * @memberOf fabric.util.ease
 */
export const easeOutBack: EasingFunction = (t, b, c, d, s = 1.70158) =>
