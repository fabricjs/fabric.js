 ...
 * @tutorial http://fabricjs.com/fabric-intro-part-1#images
 */
export class Image extends FabricObject {
  ...
  _toSVG() {
    ...
    imageMarkup.push('\t<image ', 'COMMON_PARTS', 'xlink:href="', this.getSrc(true),
  ...
  static fromObject(object, options) {
    ...
    var imageOptions = Object.assign({}, options, { crossOrigin: _object.crossOrigin }),
      filterOptions = Object.assign({}, options, { namespace: Image.filters });
    return Promise.all([
      ...
      .then(function (imgAndFilters) {
        ...
        return new Image(imgAndFilters[0], Object.assign(_object, imgAndFilters[3]));
      });
  };
