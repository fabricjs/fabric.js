...
/**
 * Returns Layer instance from an object representation
 * @static
 * @memberOf Layer
 * @param {Object} object Object to create an instance from
 * @returns {Promise<Layer>}
 */
Layer.fromObject = function ({ objects = [], ...rest }) {
  ...
  return Promise.all([
    ...
    ([objects, enlivedMap]) =>
      new Layer(objects, { ...options, ...enlivedMap }, true)
  );
};
