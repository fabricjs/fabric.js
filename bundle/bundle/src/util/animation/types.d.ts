 ...
 */
export type TOnAnimationChangeCallback<T, R = void> = (value: T, valueRatio: number, durationRatio: number) => R;
/**
...
export type TAnimationOptions<T, TCallback = T, TEasing = T> = Partial<TAnimationBaseOptions<TEasing> & TAnimationValues<T> & TAnimationCallbacks<TCallback>>;
