...
type DropEventData = DragEventData & {
    pointer: Point;
};
type DnDEvents = {
...
export type ObjectEvents = ObjectPointerEvents & DnDEvents & MiscEvents & ObjectModificationEvents & {
...
export type CanvasEvents = StaticCanvasEvents & CanvasPointerEvents & CanvasDnDEvents & MiscEvents & CanvasModificationEvents & CanvasSelectionEvents & {
    'before:path:created': {
        path: FabricObject;
    };
    'path:created': {
