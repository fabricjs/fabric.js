...
import { TextStyle, TextStyleDeclaration, TextStyleMixin } from '../mixins/text_style.mixin';
 ...
 */
export declare class Text<EventSpec extends ObjectEvents = ObjectEvents> extends TextStyleMixin<EventSpec> {
    /**
...
//# sourceMappingURL=text.class.d.ts.map