**Version 2.0.3**
  ...
  - Fix onBeforeScaleRotate with canvas zoom [#4734](https://github.com/kangax/fabric.js/pull/4734)

**Version 2.0.2**
  - fixed image toSVG support for crop [#4738](https://github.com/kangax/fabric.js/pull/4738)
  - changed math for better rounded results [#4748](https://github.com/kangax/fabric.js/pull/4748)
