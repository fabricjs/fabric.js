...
const REPO_ROOT_NODE = path.resolve(process.cwd(), '..', '..');
const ASSET_DIR_NODE = path.join(REPO_ROOT_NODE, 'test', 'visual', 'assets');
const FIXTURE_DIR_NODE = path.join(REPO_ROOT_NODE, 'test', 'fixtures');
