...
(function () {
    ...
    */
    ...
    /**
    * Indicates whether object transparency should be ignored during hit testing
    * @property
    * @type Boolean
    */
    ...
    /**
    * Tolerance for transparency hit testing.
    * Value is amount of pixels around the target area.
    * @property
    * @type Boolean
    */
    ...
    */
    ...
    /**
    * Checks for transparency of the pixel at x,y of target  
    * @private
    * @method _checkTransparencyOfTarget
    */
    ...
    *Creates a canvas instance but does not add it to the DOM
    */
...
(function(global) {
  ...
  fabric.Object = fabric.util.createClass(/** @scope fabric.Object.prototype */ {
    ...
    /**
    * Indicates whether to always take transparency into account for hit testing of this object.
    * @property
    * @type Boolean
    */
    forceCheckTransparency: false,
    ...
    toObject: function() {
      ...
      var object = {
        ...
        forceCheckTransparency: this.forceCheckTransparency
      };
