...
case "object":if(!u)return"null";e+=b;v=[];if(Object.prototype.toString.apply(u)==="[object Array]"){x=u.length;for(q=0;q<x;q+=1)v[q]=c(q,u)||"null";s=v.length===0?"[]":e?"[\n"+e+v.join(",\n"+e)+"\n"+t+"]":"["+v.join(",")+"]";e=t;return s}if(d&&typeof d==="object"){x=d.length;for(q=0;q<x;q+=1){r=d[q];if(typeof r==="string")if(s=c(r,u))v.push(o(r)+(e?": ":":")+s)}}else for(r in u)if(Object.hasOwnProperty.call(u,r))if(s=c(r,u))v.push(o(r)+(e?": ":":")+s);s=v.length===0?"{}":e?"{\n"+e+v.join(",\n"+e)+
...
k=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,e,b,a={"\u0008":"\\b","\t":"\\t","\n":"\\n","\u000c":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},d;if(typeof JSON.stringify!=="function")JSON.stringify=function(h,n,q){var r;b=e="";if(typeof q==="number")for(r=0;r<q;r+=1)b+=" ";else if(typeof q==="string")b=q;if((d=n)&&typeof n!=="function"&&(typeof n!=="object"||typeof n.length!=="number"))throw Error("JSON.stringify");return c("",
...
(function(){function g(k,e){for(var b in e)k[b]=e[b];return k}function o(k,e){var b=document.createElement(k);for(var a in e)if(a==="class")b.className=e[a];else if(a==="for")b.htmlFor=e[a];else b.setAttribute(a,e[a]);return b}var c=this.fabric||(this.fabric={}),m=Array.prototype.slice;c.util={};(function(){var k=Math.PI/180;c.util.removeFromArray=function(e,b){var a=e.indexOf(b);a!==-1&&e.splice(a,1);return e};c.util.degreesToRadians=function(e){return e*k};c.util.toFixed=function(e,b){return parseFloat(Number(e).toFixed(b))};
...
emptyFunction;return b.prototype.constructor=b}})();(function(){function k(t){var v=Array.prototype.slice.call(arguments,1),u,y,f=v.length;for(y=0;y<f;y++){u=typeof t[v[y]];if(!/^(?:function|object|unknown)$/.test(u))return false}return true}function e(t,v){return function(u){v.call(d(t),u||window.event)}}function b(t,v){return function(u){if(s[t]&&s[t][v])for(var y=s[t][v],f=0,l=y.length;f<l;f++)y[f].call(this,u||window.event)}}var a=function(){if(typeof document.documentElement.uniqueID!=="undefined")return function(v){return v.uniqueID};
var t=0;return function(v){return v.__uniqueID||(v.__uniqueID="uniqueID__"+t++)}}(),d,h;(function(){var t={};d=function(v){return t[v]};h=function(v,u){t[v]=u}})();var n=k(document.documentElement,"addEventListener","removeEventListener")&&k(window,"addEventListener","removeEventListener"),q=k(document.documentElement,"attachEvent","detachEvent")&&k(window,"attachEvent","detachEvent"),r={},s={};if(n){addListener=function(t,v,u){t.addEventListener(v,u,false)};removeListener=function(t,v,u){t.removeEventListener(v,
u,false)}}else if(q){addListener=function(t,v,u){var y=a(t);h(y,t);r[y]||(r[y]={});r[y][v]||(r[y][v]=[]);u={handler:u,wrappedHandler:e(y,u)};r[y][v].push(u);t.attachEvent("on"+v,u.wrappedHandler)};removeListener=function(t,v,u){var y=a(t),f;if(r[y]&&r[y][v])for(var l=0,p=r[y][v].length;l<p;l++)if((f=r[y][v][l])&&f.handler===u){t.detachEvent("on"+v,f.wrappedHandler);r[y][v][l]=null}}}else{addListener=function(t,v,u){var y=a(t);s[y]||(s[y]={});if(!s[y][v]){s[y][v]=[];var f=t["on"+v];f&&s[y][v].push(f);
t["on"+v]=b(y,v)}s[y][v].push(u)};removeListener=function(t,v,u){t=a(t);if(s[t]&&s[t][v]){v=s[t][v];t=0;for(var y=v.length;t<y;t++)v[t]===u&&v.splice(t,1)}}}c.util.addListener=addListener;c.util.removeListener=removeListener;var x={};c.util.observeEvent=function(t,v){x[t]||(x[t]=[]);x[t].push(v)};c.util.fireEvent=function(t,v){var u=x[t];if(u)for(var y=0,f=u.length;y<f;y++)u[y]({memo:v})};c.util.getPointer=function(t){var v=document.documentElement,u=document.body||{scrollLeft:0},y=document.documentElement,
f=document.body||{scrollTop:0};return{x:t.pageX||t.clientX+(v.scrollLeft||u.scrollLeft)-(v.clientLeft||0),y:t.pageY||t.clientY+(y.scrollTop||f.scrollTop)-(y.clientTop||0)}}})(this);(function(){var k=document.createElement("div"),e=typeof k.style.filter==="string",b=/alpha\s*\(\s*opacity\s*=\s*([^\)]+)\)/,a=function(d){return d};if(typeof k.style.opacity==="string")a=function(d,h){d.style.opacity=h;return d};else if(e)a=function(d,h){var n=d.style;if(d.currentStyle&&!d.currentStyle.hasLayout)n.zoom=
1;if(b.test(n.filter)){h=h>=0.9999?"":"alpha(opacity="+h*100+")";n.filter=n.filter.replace(b,h)}else n.filter+=" alpha(opacity="+h*100+")";return d};c.util.setStyle=function(d,h){var n=d.style;if(typeof h==="string"){d.style.cssText+=";"+h;return h.indexOf("opacity")>-1?a(d,h.match(/opacity:\s*(\d?\.?\d*)/)[1]):d}for(var q in h)if(q==="opacity")a(d,h[q]);else n[q==="float"||q==="cssFloat"?typeof n.styleFloat==="undefined"?"cssFloat":"styleFloat":q]=h[q];return d}})();(function(){var k=document.documentElement.style,
...
return e};c.util.makeElement=o;c.util.addClass=function(k,e){if((" "+k.className+" ").indexOf(" "+e+" ")===-1)k.className+=(k.className?" ":"")+e};c.util.wrapElement=function(k,e,b){if(typeof e==="string")e=o(e,b);k.parentNode&&k.parentNode.replaceChild(e,k);e.appendChild(k);return e};c.util.getElementOffset=function(k){var e=0,b=0;do{e+=k.offsetTop||0;b+=k.offsetLeft||0;k=k.offsetParent}while(k);return{left:b,top:e}};c.util.animate=function(k){k||(k={});var e=+new Date,b=k.duration||500,a=e+b,d,
h,n=k.onChange||function(){},q=k.easing||function(v){return-Math.cos(v*Math.PI)/2+0.5},r="startValue"in k?k.startValue:0,s="endValue"in k?k.endValue:100,x=r>s;k.onStart&&k.onStart();var t=setInterval(function(){d=+new Date;h=d>a?1:(d-e)/b;n(x?r-(r-s)*q(h):r+(s-r)*q(h));if(d>a){clearInterval(t);k.onComplete&&k.onComplete()}},10)};(function(){function k(){}var e=function(){for(var b=[function(){return new ActiveXObject("Microsoft.XMLHTTP")},function(){return new ActiveXObject("Msxml2.XMLHTTP")},function(){return new ActiveXObject("Msxml2.XMLHTTP.3.0")},
function(){return new XMLHttpRequest}],a=b.length;a--;)try{if(b[a]())return b[a]}catch(d){}}();c.util.request=function(b,a){a||(a={});var d=a.method?a.method.toUpperCase():"GET",h=a.onComplete||function(){},n=e(),q;n.onreadystatechange=function(){if(n.readyState===4){h(n);n.onreadystatechange=k}};if(d==="GET"){q=null;if(typeof a.parameters=="string")b=b+(/\?/.test(b)?"&":"?")+a.parameters}n.open(d,b,true);if(d==="POST"||d==="PUT")n.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
n.send(q);return n}})()})(this);
(function(){var g=this.fabric||(this.fabric={}),o=g.util.object.extend,c=g.util.string.capitalize,m=g.util.object.clone,k={cx:"left",x:"left",cy:"top",y:"top",r:"radius","fill-opacity":"opacity","fill-rule":"fillRule","stroke-width":"strokeWidth",transform:"transformMatrix"};g.parseTransformAttribute=function(){function e(q,r){var s=r[0];q[0]=Math.cos(s);q[1]=Math.sin(s);q[2]=-Math.sin(s);q[3]=Math.cos(s)}function b(q,r){var s=r.length===2?r[1]:r[0];q[0]=r[0];q[3]=s}function a(q,r){q[4]=r[0];if(r.length===
...
return function(q){var r=d.concat();if(!q||q&&!h.test(q))return r;q.replace(n,function(s){var x=RegExp("(?:(?:(matrix)\\s*\\(\\s*((?:[-+]?\\d+(?:\\.\\d+)?(?:e[-+]?\\d+)?))(?:\\s+,?\\s*|,\\s*)((?:[-+]?\\d+(?:\\.\\d+)?(?:e[-+]?\\d+)?))(?:\\s+,?\\s*|,\\s*)((?:[-+]?\\d+(?:\\.\\d+)?(?:e[-+]?\\d+)?))(?:\\s+,?\\s*|,\\s*)((?:[-+]?\\d+(?:\\.\\d+)?(?:e[-+]?\\d+)?))(?:\\s+,?\\s*|,\\s*)((?:[-+]?\\d+(?:\\.\\d+)?(?:e[-+]?\\d+)?))(?:\\s+,?\\s*|,\\s*)((?:[-+]?\\d+(?:\\.\\d+)?(?:e[-+]?\\d+)?))\\s*\\))|(?:(translate)\\s*\\(\\s*((?:[-+]?\\d+(?:\\.\\d+)?(?:e[-+]?\\d+)?))(?:(?:\\s+,?\\s*|,\\s*)((?:[-+]?\\d+(?:\\.\\d+)?(?:e[-+]?\\d+)?)))?\\s*\\))|(?:(scale)\\s*\\(\\s*((?:[-+]?\\d+(?:\\.\\d+)?(?:e[-+]?\\d+)?))(?:(?:\\s+,?\\s*|,\\s*)((?:[-+]?\\d+(?:\\.\\d+)?(?:e[-+]?\\d+)?)))?\\s*\\))|(?:(rotate)\\s*\\(\\s*((?:[-+]?\\d+(?:\\.\\d+)?(?:e[-+]?\\d+)?))(?:(?:\\s+,?\\s*|,\\s*)((?:[-+]?\\d+(?:\\.\\d+)?(?:e[-+]?\\d+)?))(?:\\s+,?\\s*|,\\s*)((?:[-+]?\\d+(?:\\.\\d+)?(?:e[-+]?\\d+)?)))?\\s*\\))|(?:(skewX)\\s*\\(\\s*((?:[-+]?\\d+(?:\\.\\d+)?(?:e[-+]?\\d+)?))\\s*\\))|(?:(skewY)\\s*\\(\\s*((?:[-+]?\\d+(?:\\.\\d+)?(?:e[-+]?\\d+)?))\\s*\\)))").exec(s).filter(function(t){return t!==
...
h=g.parseElements(h,m(n));!h||h&&!h.length||d&&d(h,n)}}}}();o(g,{parseAttributes:function(e,b){if(e){var a,d,h={};if(e.parentNode&&/^g$/i.test(e.parentNode.nodeName))h=g.parseAttributes(e.parentNode,b);var n=b.reduce(function(q,r){a=e.getAttribute(r);d=parseFloat(a);if(a){if((r==="fill"||r==="stroke")&&a==="none")a="";if(r==="fill-rule")a=a==="evenodd"?"destination-over":a;if(r==="transform")a=g.parseTransformAttribute(a);if(r in k)r=k[r];q[r]=isNaN(d)?a:d}return q},{});n=o(g.parseStyleAttribute(e),
n);return o(h,n)}},parseElements:function(e,b){var a=e.map(function(d){var h=g[c(d.tagName)];if(h&&h.fromElement)try{return h.fromElement(d,b)}catch(n){console.log(n.message||n)}});return a=a.filter(function(d){return d!=null})},parseStyleAttribute:function(e){var b={};if(e=e.getAttribute("style"))if(typeof e=="string"){e=e.split(";");e.pop();b=e.reduce(function(d,h){var n=h.split(":"),q=n[0].trim();n=n[1].trim();d[q]=n;return d},{})}else for(var a in e)if(typeof e[a]!=="undefined")b[a]=e[a];return b},
...
","+this.y},setXY:function(c,m){this.x=c;this.y=m},setFromPoint:function(c){this.x=c.x;this.y=c.y},swap:function(c){var m=this.x,k=this.y;this.x=c.x;this.y=c.y;c.x=m;c.y=k}};o.Point=g}})();
(function(){function g(c){arguments.length>0&&this.init(c)}var o=this.fabric||(this.fabric={});if(o.Intersection)console.warn("fabric.Intersection is already defined");else{g.prototype.init=function(c){this.status=c;this.points=[]};g.prototype.appendPoint=function(c){this.points.push(c)};g.prototype.appendPoints=function(c){this.points=this.points.concat(c)};g.intersectLineLine=function(c,m,k,e){var b,a=(e.x-k.x)*(c.y-k.y)-(e.y-k.y)*(c.x-k.x);b=(m.x-c.x)*(c.y-k.y)-(m.y-c.y)*(c.x-k.x);k=(e.y-k.y)*
(m.x-c.x)-(e.x-k.x)*(m.y-c.y);if(k!=0){a=a/k;b=b/k;if(0<=a&&a<=1&&0<=b&&b<=1){b=new g("Intersection");b.points.push(new o.Point(c.x+a*(m.x-c.x),c.y+a*(m.y-c.y)))}else b=new g("No Intersection")}else b=a==0||b==0?new g("Coincident"):new g("Parallel");return b};g.intersectLinePolygon=function(c,m,k){for(var e=new g("No Intersection"),b=k.length,a=0;a<b;a++){var d=g.intersectLineLine(c,m,k[a],k[(a+1)%b]);e.appendPoints(d.points)}if(e.points.length>0)e.status="Intersection";return e};g.intersectPolygonPolygon=
...
e.appendPoints(k.points);e.appendPoints(b.points);e.appendPoints(c.points);if(e.points.length>0)e.status="Intersection";return e};o.Intersection=g}})();
(function(){function g(c){c?this._tryParsingColor(c):this.setSource([0,0,0,1])}var o=this.fabric||(this.fabric={});if(o.Color)console.warn("fabric.Color is already defined.");else{o.Color=g;g.prototype._tryParsingColor=function(c){var m=g.sourceFromHex(c);m||(m=g.sourceFromRgb(c));m&&this.setSource(m)};g.prototype.getSource=function(){return this._source};g.prototype.setSource=function(c){this._source=c};g.prototype.toRgb=function(){var c=this.getSource();return"rgb("+c[0]+","+c[1]+","+c[2]+")"};
...
(function(){if(fabric.Element)console.warn("fabric.Element is already defined.");else{var g=this.window,o=g.document,c=fabric.util.object.extend,m=fabric.util.string.capitalize,k=fabric.util.string.camelize,e=fabric.util.fireEvent,b=fabric.util.getPointer,a=fabric.util.getElementOffset,d=fabric.util.removeFromArray,h=fabric.util.addListener,n=fabric.util.removeListener,q=Math.sqrt,r=Math.pow,s=Math.atan2,x=Math.abs,t=Math.min,v=Math.max,u=Error("Could not initialize `canvas` element"),y={tr:"ne-resize",
br:"se-resize",bl:"sw-resize",tl:"nw-resize",ml:"w-resize",mt:"n-resize",mr:"e-resize",mb:"s-resize"};(function(){var f=o.createElement("canvas");if(f&&f.getContext)if(f=f.getContext("2d")){try{f.fillStyle="transparent";return true}catch(l){}return false}})();fabric.Element=function(f,l){this._groupSelector=null;this._objects=[];this._activeGroup=this._currentTransform=this._element=this._context=null;this._config={width:300,height:150};l=l||{};this._initElement(f);this._initConfig(l);l.overlayImage&&
...
l){var p="drag",w,A=b(f);if(w=l._findTargetCorner(f,this._offset))p=w==="ml"||w==="mr"?"scaleX":w==="mt"||w==="mb"?"scaleY":"rotate";this._currentTransform={target:l,action:p,scaleX:l.scaleX,scaleY:l.scaleY,offsetX:A.x-l.left,offsetY:A.y-l.top,ex:A.x,ey:A.y,left:l.left,top:l.top,theta:l.theta,width:l.width*l.scaleX};this._currentTransform.original={left:l.left,top:l.top}},_handleGroupLogic:function(f,l){if(l.isType("group")){l=this.findTarget(f,true);if(!l||l.isType("group"))return}var p=this.getActiveGroup();
...
this.contextTop.strokeRect(this._groupSelector.ex+0.5-(f>0?0:p),this._groupSelector.ey+0.5-(l>0?0:w),p,w)},_findSelectedObjects:function(){var f=[],l=this._groupSelector.ex,p=this._groupSelector.ey,w=l+this._groupSelector.left,A=p+this._groupSelector.top,z=new fabric.Point(t(l,w),t(p,A));p=new fabric.Point(v(l,w),v(p,A));w=0;for(A=this._objects.length;w<A;++w){l=this._objects[w];if(l.intersectsWithRect(z,p)||l.isContainedWithinRect(z,p)){l.setActive(true);f.push(l)}}if(f.length===1){this.setActiveObject(f[0]);
...
return this},clear:function(){this._objects.length=0;this.clearContext(this.contextTop);this.clearContext(this.contextContainer);this.renderAll();return this},renderAll:function(f){var l=f?this.contextTop:this.contextContainer;this.clearContext(this.contextTop);f||this.clearContext(l);f=this._objects.length;var p=this.getActiveGroup(),w=new Date;if(f)for(var A=0;A<f;++A)if(!p||p&&!p.contains(this._objects[A]))this._draw(l,this._objects[A]);p&&this._draw(this.contextTop,p);this.overlayImage&&this.contextTop.drawImage(this.overlayImage,
0,0);this.onFpsUpdate(~~(1E3/(new Date-w)));this.afterRender&&this.afterRender();return this},renderTop:function(){this.clearContext(this.contextTop);this.overlayImage&&this.contextTop.drawImage(this.overlayImage,0,0);this._groupSelector&&this._drawSelection();var f=this.getActiveGroup();f&&f.render(this.contextTop);this.afterRender&&this.afterRender();return this},containsPoint:function(f,l){var p=this.getPointer(f),w=this._normalizePointer(l,p);p=w.x;w=w.y;var A=l._getImageLines(l.oCoords);if((p=
l._findCrossPoints(p,w,A))&&p%2===1||l._findTargetCorner(f,this._offset))return true;return false},_normalizePointer:function(f,l){var p=this.getActiveGroup(),w=l.x,A=l.y;if(p&&f.type!=="group"&&p.contains(f)){w-=p.left;A-=p.top}return{x:w,y:A}},findTarget:function(f,l){var p;this.getPointer(f);var w=this.getActiveGroup();if(w&&!l&&this.containsPoint(f,w))return p=w;for(w=this._objects.length;w--;)if(this.containsPoint(f,this._objects[w])){this.relatedTarget=p=this._objects[w];break}return p},toDataURL:function(f){var l;
f||(f="png");if(f==="jpeg"||f==="png"){this.renderAll(true);l=this.getElement().toDataURL("image/"+f);this.renderAll()}return l},toDataURLWithMultiplier:function(f,l){var p=this.getWidth(),w=this.getHeight(),A=p*l,z=w*l,B=this.getActiveObject();this.setWidth(A).setHeight(z);this.contextTop.scale(l,l);B&&this.deactivateAll().renderAll();A=this.toDataURL(f);this.contextTop.scale(1/l,1/l);this.setWidth(p).setHeight(w);B&&this.setActiveObject(B);this.renderAll();return A},getPointer:function(f){f=b(f);
return{x:f.x-this._offset.left,y:f.y-this._offset.top}},getCenter:function(){return{top:this.getHeight()/2,left:this.getWidth()/2}},centerObjectH:function(f){f.set("left",this.getCenter().left);this.renderAll();return this},fxCenterObjectH:function(f,l){l=l||{};var p=function(){},w=l.onComplete||p,A=l.onChange||p,z=this;fabric.util.animate({startValue:f.get("left"),endValue:this.getCenter().left,duration:this.FX_DURATION,onChange:function(B){f.set("left",B);z.renderAll();A()},onComplete:function(){f.setCoords();
w()}});return this},centerObjectV:function(f){f.set("top",this.getCenter().top);this.renderAll();return this},fxCenterObjectV:function(f,l){l=l||{};var p=function(){},w=l.onComplete||p,A=l.onChange||p,z=this;fabric.util.animate({startValue:f.get("top"),endValue:this.getCenter().top,duration:this.FX_DURATION,onChange:function(B){f.set("top",B);z.renderAll();A()},onComplete:function(){f.setCoords();w()}});return this},straightenObject:function(f){f.straighten();this.renderAll();return this},fxStraightenObject:function(f){f.fxStraighten({onChange:this.renderAll.bind(this)});
return this},toDatalessJSON:function(){return this.toDatalessObject()},toObject:function(){return this._toObjectMethod("toObject")},toDatalessObject:function(){return this._toObjectMethod("toDatalessObject")},_toObjectMethod:function(f){return{objects:this._objects.map(function(l){if(!this.includeDefaultValues){var p=l.includeDefaultValues;l.includeDefaultValues=false}var w=l[f]();if(!this.includeDefaultValues)l.includeDefaultValues=p;return w},this),background:this.backgroundColor}},isEmpty:function(){return this._objects.length===
0},loadFromJSON:function(f,l){if(f){var p=JSON.parse(f);if(!(!p||p&&!p.objects)){this.clear();var w=this;this._enlivenObjects(p.objects,function(){w.backgroundColor=p.background;l&&l()});return this}}},_enlivenObjects:function(f,l){var p=0,w=f.filter(function(z){return z.type==="image"}).length,A=this;f.forEach(function(z){if(z.type)switch(z.type){case "image":case "font":fabric[m(z.type)].fromObject(z,function(C){A.add(C);++p===w&&l&&l()});break;default:var B=fabric[k(m(z.type))];B&&B.fromObject&&
A.add(B.fromObject(z));break}});w===0&&l&&l()},loadFromDatalessJSON:function(f,l){if(f){var p=typeof f==="string"?JSON.parse(f):f;if(!(!p||p&&!p.objects)){this.clear();this.backgroundColor=p.background;this._enlivenDatalessObjects(p.objects,l)}}},_enlivenDatalessObjects:function(f,l){function p(C,E){w.insertAt(C,E);C.setCoords();++A===z&&l&&l()}var w=this,A=0,z=f.length;z===0&&l&&l();try{f.forEach(function(C,E){var G=C.paths?"paths":"path",F=C[G];delete C[G];if(typeof F!=="string")switch(C.type){case "image":case "text":fabric[m(C.type)].fromObject(C,
function(D){p(D,E)});break;default:(G=fabric[k(m(C.type))])&&G.fromObject&&p(G.fromObject(C),E);break}else if(C.type==="image")w.loadImageFromURL(F,function(D){D.setSourcePath(F);c(D,C);D.setAngle(C.angle);p(D,E)});else if(C.type==="text"){C.path=F;var H=fabric.Text.fromObject(C);fabric.util.getScript(F,function(){Object.prototype.toString.call(g.opera)==="[object Opera]"?setTimeout(function(){p(H,E)},500):p(H,E)})}else w.loadSVGFromURL(F,function(D){D=D.length>1?new fabric.PathGroup(D,C):D[0];D.setSourcePath(F);
...
Element.identify(z);o.body.appendChild(z)}}}(),loadSVGFromURL:function(f,l){function p(z){if(z=z.responseXML)(z=z.documentElement)&&fabric.parseSVGDocument(z,function(B,C){A.cache.set(f,{objects:B.invoke("toObject"),options:C});l(B,C)})}function w(){console.log("ERROR!")}var A=this;f=f.replace(/^\n\s*/,"").replace(/\?.*$/,"").trim();this.cache.has(f,function(z){if(z)A.cache.get(f,function(B){B=A._enlivenCachedObject(B);l(B.objects,B.options)});else new Ajax.Request(f,{method:"get",onComplete:p,onFailure:w})})},
_enlivenCachedObject:function(f){var l=f.objects;f=f.options;l=l.map(function(p){return fabric[m(p.type)].fromObject(p)});return{objects:l,options:f}},remove:function(f){d(this._objects,f);this.renderAll();return f},fxRemove:function(f,l){var p=this;f.fxRemove({onChange:this.renderAll.bind(this),onComplete:function(){p.remove(f);typeof l==="function"&&l()}});return this},sendToBack:function(f){d(this._objects,f);this._objects.unshift(f);return this.renderAll()},bringToFront:function(f){d(this._objects,
f);this._objects.push(f);return this.renderAll()},sendBackwards:function(f){var l=this._objects.indexOf(f),p=l;if(l!==0){for(l=l-1;l>=0;--l)if(f.intersectsWithObject(this._objects[l])){p=l;break}d(this._objects,f);this._objects.splice(p,0,f)}return this.renderAll()},bringForward:function(f){var l=this.getObjects(),p=l.indexOf(f),w=p;if(p!==l.length-1){p=p+1;for(var A=this._objects.length;p<A;++p)if(f.intersectsWithObject(l[p])){w=p;break}d(l,f);l.splice(w,0,f)}this.renderAll()},setActiveObject:function(f){this._activeObject&&
...
item:function(f){return this.getObjects()[f]},deactivateAll:function(){for(var f=this.getObjects(),l=0,p=f.length;l<p;l++)f[l].setActive(false);this.removeActiveGroup();this.removeActiveObject();return this},complexity:function(){return this.getObjects().reduce(function(f,l){f+=l.complexity?l.complexity():0;return f},0)},dispose:function(){this.clear();n(this.getElement(),"mousedown",this._onMouseDown);n(o,"mouseup",this._onMouseUp);n(o,"mousemove",this._onMouseMove);n(g,"resize",this._onResize);
return this},clone:function(f){var l=o.createElement("canvas");l.width=this.getWidth();l.height=this.getHeight();var p=this.__clone||(this.__clone=new fabric.Element(l));return p.loadFromJSON(this.toJSON(),function(){f&&f(p)})},_toDataURL:function(f,l){this.clone(function(p){l(p.toDataURL(f))})},_toDataURLWithMultiplier:function(f,l,p){this.clone(function(w){p(w.toDataURLWithMultiplier(f,l))})},_resizeImageToFit:function(f){var l=f.width||f.offsetWidth,p=this.getWidth()/l;if(l)f.width=l*p},cache:{has:function(f,
l){l(false)},get:function(){},set:function(){}}});fabric.Element.prototype.toString=function(){return"#<fabric.Element ("+this.complexity()+"): { objects: "+this.getObjects().length+" }>"};c(fabric.Element,{EMPTY_JSON:'{"objects": [], "background": "white"}',toGrayscale:function(f){var l=f.getContext("2d");f=l.getImageData(0,0,f.width,f.height);var p=f.data,w=f.width,A=f.height,z,B;for(i=0;i<w;i++)for(j=0;j<A;j++){z=i*4*A+j*4;B=(p[z]+p[z+1]+p[z+2])/3;p[z]=B;p[z+1]=B;p[z+2]=B}l.putImageData(f,0,0)},
supports:function(f){var l=o.createElement("canvas");if(!l||!l.getContext)return null;var p=l.getContext("2d");if(!p)return null;switch(f){case "getImageData":return typeof p.getImageData!=="undefined";case "toDataURL":return typeof l.toDataURL!=="undefined";default:return null}}});fabric.Element.prototype.toJSON=fabric.Element.prototype.toObject}})();
(function(){var g=this.fabric||(this.fabric={}),o=g.util.object.extend,c=g.util.object.clone,m=g.util.toFixed,k=g.util.string.capitalize,e=g.util.getPointer,b=Array.prototype.slice;if(!g.Object){g.Object=g.util.createClass({type:"object",includeDefaultValues:true,NUM_FRACTION_DIGITS:2,FX_DURATION:500,FX_TRANSITION:"decel",MIN_SCALE_LIMIT:0.1,stateProperties:"top left width height scaleX scaleY flipX flipY theta angle opacity cornersize fill overlayFill stroke strokeWidth fillRule borderScaleFactor transformMatrix".split(" "),
...
2,2)+Math.pow(this.currentHeight/2,2));this._angle=Math.atan(this.currentHeight/this.currentWidth);var a=Math.cos(this._angle+this.theta)*this._hypotenuse,d=Math.sin(this._angle+this.theta)*this._hypotenuse,h=this.theta,n=Math.sin(h);h=Math.cos(h);a={x:this.left-a,y:this.top-d};d={x:a.x+this.currentWidth*h,y:a.y+this.currentWidth*n};var q={x:a.x-this.currentHeight*n,y:a.y+this.currentHeight*h};this.oCoords={tl:a,tr:d,br:{x:d.x-this.currentHeight*n,y:d.y+this.currentHeight*h},bl:q,ml:{x:a.x-this.currentHeight/
2*n,y:a.y+this.currentHeight/2*h},mt:{x:a.x+this.currentWidth/2*h,y:a.y+this.currentWidth/2*n},mr:{x:d.x-this.currentHeight/2*n,y:d.y+this.currentHeight/2*h},mb:{x:q.x+this.currentWidth/2*h,y:q.y+this.currentWidth/2*n}};this._setCornerCoords();return this},drawBorders:function(a){var d=this.options,h=d.padding,n=h*2;a.save();a.globalAlpha=this.isMoving?d.borderOpacityWhenMoving:1;a.strokeStyle=d.borderColor;d=1/(this.scaleX<this.MIN_SCALE_LIMIT?this.MIN_SCALE_LIMIT:this.scaleX);var q=1/(this.scaleY<
this.MIN_SCALE_LIMIT?this.MIN_SCALE_LIMIT:this.scaleY);a.lineWidth=1/this.borderScaleFactor;a.scale(d,q);d=this.getWidth();q=this.getHeight();a.strokeRect(~~(-(d/2)-h)+0.5,~~(-(q/2)-h)+0.5,~~(d+n),~~(q+n));a.restore();return this},drawCorners:function(a){var d=this.options.cornersize,h=d/2,n=this.options.padding,q=-(this.width/2),r=-(this.height/2),s=d/this.scaleX,x=d/this.scaleY,t=(n+h)/this.scaleY,v=(n+h)/this.scaleX,u=(n+h-d)/this.scaleX;n=(n+h-d)/this.scaleY;a.save();a.globalAlpha=this.isMoving?
this.options.borderOpacityWhenMoving:1;a.fillStyle=this.options.cornerColor;d=q-v;h=r-t;a.fillRect(d,h,s,x);d=q+this.width-v;h=r-t;a.fillRect(d,h,s,x);d=q-v;h=r+this.height+n;a.fillRect(d,h,s,x);d=q+this.width+u;h=r+this.height+n;a.fillRect(d,h,s,x);d=q+this.width/2-v;h=r-t;a.fillRect(d,h,s,x);d=q+this.width/2-v;h=r+this.height+n;a.fillRect(d,h,s,x);d=q+this.width+u;h=r+this.height/2-t;a.fillRect(d,h,s,x);d=q-v;h=r+this.height/2-t;a.fillRect(d,h,s,x);a.restore();return this},clone:function(a){if(this.constructor.fromObject)return this.constructor.fromObject(this.toObject(),
...
"transparent";d.renderAll();var h=this.clone();h.left=a.width/2;h.top=a.height/2;h.setActive(false);d.add(h);a=d.toDataURL("png");d.dispose();return a},hasStateChanged:function(){return this.stateProperties.some(function(a){return this[a]!==this.originalState[a]},this)},saveState:function(){this.stateProperties.forEach(function(a){this.originalState[a]=this.get(a)},this);return this},intersectsWithRect:function(a,d){var h=this.oCoords,n=new g.Point(h.tl.x,h.tl.y),q=new g.Point(h.tr.x,h.tr.y),r=new g.Point(h.bl.x,
h.bl.y);h=new g.Point(h.br.x,h.br.y);return g.Intersection.intersectPolygonRectangle([n,q,h,r],a,d).status==="Intersection"},intersectsWithObject:function(a){function d(n){return{tl:new g.Point(n.tl.x,n.tl.y),tr:new g.Point(n.tr.x,n.tr.y),bl:new g.Point(n.bl.x,n.bl.y),br:new g.Point(n.br.x,n.br.y)}}var h=d(this.oCoords);a=d(a.oCoords);return g.Intersection.intersectPolygonPolygon([h.tl,h.tr,h.br,h.bl],[a.tl,a.tr,a.br,a.bl]).status==="Intersection"},isContainedWithinRect:function(a,d){var h=this.oCoords,
n=new g.Point(h.tl.x,h.tl.y),q=new g.Point(h.tr.x,h.tr.y),r=new g.Point(h.bl.x,h.bl.y);new g.Point(h.br.x,h.br.y);return n.x>a.x&&q.x<d.x&&n.y>a.y&&r.y<d.y},isType:function(a){return this.type===a},_findTargetCorner:function(a,d){var h=e(a),n=h.x-d.left;h=h.y-d.top;var q;for(var r in this.oCoords){q=this._getImageLines(this.oCoords[r].corner,r);q=this._findCrossPoints(n,h,q);if(q%2==1&&q!=0)return this.__corner=r}return false},_findCrossPoints:function(a,d,h){var n,q,r,s=0;for(var x in h){r=h[x];
if(!(r.o.y<d&&r.d.y<d))if(!(r.o.y>=d&&r.d.y>=d)){if(r.o.x==r.d.x&&r.o.x>=a)n=r.o.x;else{n=(r.d.y-r.o.y)/(r.d.x-r.o.x);q=d-0*a;r=r.o.y-n*r.o.x;n=-(q-r)/(0-n)}if(n>=a)s+=1;if(s==2)break}}return s},_getImageLines:function(a){return{topline:{o:a.tl,d:a.tr},rightline:{o:a.tr,d:a.br},bottomline:{o:a.br,d:a.bl},leftline:{o:a.bl,d:a.tl}}},_setCornerCoords:function(){var a=this.oCoords,d=this.theta,h=this.cornersize*Math.cos(d),n=this.cornersize*Math.sin(d);d=this.cornersize/2;var q=d-n;a.tl.x-=q;a.tl.y-=
d;a.tl.corner={tl:{x:a.tl.x,y:a.tl.y},tr:{x:a.tl.x+h,y:a.tl.y+n},bl:{x:a.tl.x-n,y:a.tl.y+h}};a.tl.corner.br={x:a.tl.corner.tr.x-n,y:a.tl.corner.tr.y+h};a.tl.x+=q;a.tl.y+=d;a.tr.x+=d;a.tr.y-=d;a.tr.corner={tl:{x:a.tr.x-h,y:a.tr.y-n},tr:{x:a.tr.x,y:a.tr.y},br:{x:a.tr.x-n,y:a.tr.y+h}};a.tr.corner.bl={x:a.tr.corner.tl.x-n,y:a.tr.corner.tl.y+h};a.tr.x-=d;a.tr.y+=d;a.bl.x-=d;a.bl.y+=d;a.bl.corner={tl:{x:a.bl.x+n,y:a.bl.y-h},bl:{x:a.bl.x,y:a.bl.y},br:{x:a.bl.x+h,y:a.bl.y+n}};a.bl.corner.tr={x:a.bl.corner.br.x+
n,y:a.bl.corner.br.y-h};a.bl.x+=d;a.bl.y-=d;a.br.x+=d;a.br.y+=d;a.br.corner={tr:{x:a.br.x+n,y:a.br.y-h},bl:{x:a.br.x-h,y:a.br.y-n},br:{x:a.br.x,y:a.br.y}};a.br.corner.tl={x:a.br.corner.bl.x+n,y:a.br.corner.bl.y-h};a.br.x-=d;a.br.y-=d;a.ml.x-=d;a.ml.y-=d;a.ml.corner={tl:{x:a.ml.x,y:a.ml.y},tr:{x:a.ml.x+h,y:a.ml.y+n},bl:{x:a.ml.x-n,y:a.ml.y+h}};a.ml.corner.br={x:a.ml.corner.tr.x-n,y:a.ml.corner.tr.y+h};a.ml.x+=d;a.ml.y+=d;a.mt.x-=d;a.mt.y-=d;a.mt.corner={tl:{x:a.mt.x,y:a.mt.y},tr:{x:a.mt.x+h,y:a.mt.y+
n},bl:{x:a.mt.x-n,y:a.mt.y+h}};a.mt.corner.br={x:a.mt.corner.tr.x-n,y:a.mt.corner.tr.y+h};a.mt.x+=d;a.mt.y+=d;a.mr.x-=d;a.mr.y-=d;a.mr.corner={tl:{x:a.mr.x,y:a.mr.y},tr:{x:a.mr.x+h,y:a.mr.y+n},bl:{x:a.mr.x-n,y:a.mr.y+h}};a.mr.corner.br={x:a.mr.corner.tr.x-n,y:a.mr.corner.tr.y+h};a.mr.x+=d;a.mr.y+=d;a.mb.x-=d;a.mb.y-=d;a.mb.corner={tl:{x:a.mb.x,y:a.mb.y},tr:{x:a.mb.x+h,y:a.mb.y+n},bl:{x:a.mb.x-n,y:a.mb.y+h}};a.mb.corner.br={x:a.mb.corner.tr.x-n,y:a.mb.corner.tr.y+h};a.mb.x+=d;a.mb.y+=d;a=a.mb.corner;
a.tl.x-=d;a.tl.y-=d;a.tr.x-=d;a.tr.y-=d;a.br.x-=d;a.br.y-=d;a.bl.x-=d;a.bl.y-=d},toGrayscale:function(){var a=this.get("fill");a&&this.set("overlayFill",(new g.Color(a)).toGrayscale().toRgb());return this},complexity:function(){return 0},getCenter:function(){return{x:this.get("left")+this.width/2,y:this.get("top")+this.height/2}},straighten:function(){this.setAngle(this._getAngleValueForStraighten());return this},fxStraighten:function(a){a=a||{};var d=function(){},h=a.onComplete||d,n=a.onChange||
d,q=this;g.util.animate({startValue:this.get("angle"),endValue:this._getAngleValueForStraighten(),duration:this.FX_DURATION,onChange:function(r){q.setAngle(r);n()},onComplete:function(){q.setCoords();h()},onStart:function(){q.setActive(false)}});return this},fxRemove:function(a){a||(a={});var d=function(){},h=a.onComplete||d,n=a.onChange||d,q=this;g.util.animate({startValue:this.get("opacity"),endValue:0,duration:this.FX_DURATION,onChange:function(r){q.set("opacity",r);n()},onComplete:h,onStart:function(){q.setActive(false)}});
...
"x y width height rx ry fill fill-opacity stroke stroke-width transform".split(" ");g.Rect.fromElement=function(o,c){if(!o)return null;var m=g.parseAttributes(o,g.Rect.ATTRIBUTE_NAMES);m=m;m.left=m.left||0;m.top=m.top||0;m=m;var k=new g.Rect(g.util.object.extend(c||{},m));k._normalizeLeftTopProperties(m);return k};g.Rect.fromObject=function(o){return new g.Rect(o)}}})();
...
(function(){var g=this.fabric||(this.fabric={}),o=g.util.array.min,c=g.util.array.max,m=g.util.object.extend;if(g.Path)console.warn("fabric.Path is already defined");else if(g.Object){g.Path=g.util.createClass(g.Object,{type:"path",initialize:function(e,b){b=b||{};this.setOptions(b);this._importProperties();this.originalState={};if(!e)throw Error("`path` argument is required");var a=Object.prototype.toString.call(e)==="[object Array]";if(this.path=a?e:e.match&&e.match(/[a-zA-Z][^a-zA-Z]*/g)){a||this._initializeFromArray(b);
this.setCoords();b.sourcePath&&this.setSourcePath(b.sourcePath)}},_initializeFromArray:function(e){var b="width"in e;e="height"in e;this.path=this._parsePath();if(!b||!e){m(this,this._parseDimensions());if(b)this.width=this.options.width;if(e)this.height=this.options.height}},_render:function(e){for(var b,a=0,d=0,h=0,n=0,q,r,s=-(this.width/2),x=-(this.height/2),t=0,v=this.path.length;t<v;++t){b=this.path[t];switch(b[0]){case "l":a+=b[1];d+=b[2];e.lineTo(a+s,d+x);break;case "L":a=b[1];d=b[2];e.lineTo(a+
s,d+x);break;case "h":a+=b[1];e.lineTo(a+s,d+x);break;case "H":a=b[1];e.lineTo(a+s,d+x);break;case "v":d+=b[1];e.lineTo(a+s,d+x);break;case "V":d=b[1];e.lineTo(a+s,d+x);break;case "m":a+=b[1];d+=b[2];e.moveTo(a+s,d+x);break;case "M":a=b[1];d=b[2];e.moveTo(a+s,d+x);break;case "c":q=a+b[5];r=d+b[6];h=a+b[3];n=d+b[4];e.bezierCurveTo(a+b[1]+s,d+b[2]+x,h+s,n+x,q+s,r+x);a=q;d=r;break;case "C":a=b[5];d=b[6];h=b[3];n=b[4];e.bezierCurveTo(b[1]+s,b[2]+x,h+s,n+x,a+s,d+x);break;case "s":q=a+b[3];r=d+b[4];h=2*
a-h;n=2*d-n;e.bezierCurveTo(h+s,n+x,a+b[1]+s,d+b[2]+x,q+s,r+x);a=q;d=r;break;case "S":q=b[3];r=b[4];h=2*a-h;n=2*d-n;e.bezierCurveTo(h+s,n+x,b[1]+s,b[2]+x,q+s,r+x);a=q;d=r;break;case "q":a+=b[3];d+=b[4];e.quadraticCurveTo(b[1]+s,b[2]+x,a+s,d+x);break;case "Q":a=b[3];d=b[4];h=b[1];n=b[2];e.quadraticCurveTo(h+s,n+x,a+s,d+x);break;case "T":q=a;r=d;a=b[1];d=b[2];h=-h+2*q;n=-n+2*r;e.quadraticCurveTo(h+s,n+x,a+s,d+x);break;case "a":break;case "A":break;case "z":case "Z":e.closePath();break}}},render:function(e,
...
true);if(this.active){this.drawBorders(a);this.hideCorners||this.drawCorners(a)}}a.restore()},set:function(a,d){if((a==="fill"||a==="overlayFill")&&this.isSameColor()){this[a]=d;for(var h=this.paths.length;h--;)this.paths[h].set(a,d)}else m.call(this,a,d);return this},toObject:function(){return o(k.call(this),{paths:c(this.getObjects(),"clone"),sourcePath:this.sourcePath})},toDatalessObject:function(){var a=this.toObject();if(this.sourcePath)a.paths=this.sourcePath;return a},toString:function(){return"#<fabric.PathGroup ("+
...
h=0,n=d.length;h<n;h++)if(!(d[h]instanceof g.Object)){var q=e(b(d[h].type));d[h]=g[q].fromObject(d[h])}return new g.PathGroup(d,a)}}})();
(function(){var g=this.fabric||(this.fabric={}),o=g.util.object.extend,c=g.util.array.min,m=g.util.array.max,k=g.util.array.invoke,e=g.util.removeFromArray;if(!g.Group){g.Group=g.util.createClass(g.Object,{type:"group",initialize:function(b,a){this.objects=b||[];this.originalState={};this.callSuper("initialize");this._calcBounds();this._updateObjectsCoords();a&&o(this,a);this._setOpacityIfSame();this.setCoords(true);this.saveCoords();this.activateAllObjects()},_updateObjectsCoords:function(){var b=
this.left,a=this.top;this.forEachObject(function(d){var h=d.get("left"),n=d.get("top");d.set("originalLeft",h);d.set("originalTop",n);d.set("left",h-b);d.set("top",n-a);d.setCoords();d.hideCorners=true},this)},toString:function(){return"#<fabric.Group: ("+this.complexity()+")>"},getObjects:function(){return this.objects},add:function(b){this._restoreObjectsState();this.objects.push(b);b.setActive(true);this._calcBounds();this._updateObjectsCoords();return this},remove:function(b){this._restoreObjectsState();
e(this.objects,b);b.setActive(false);this._calcBounds();this._updateObjectsCoords();return this},size:function(){return this.getObjects().length},set:function(b,a){if(typeof a=="function")this.set(b,a(this[b]));else if(b==="fill"||b==="opacity"){var d=this.objects.length;for(this[b]=a;d--;)this.objects[d].set(b,a)}else this[b]=a;return this},contains:function(b){return this.objects.indexOf(b)>-1},toObject:function(){return o(this.callSuper("toObject"),{objects:k(this.objects,"clone")})},render:function(b){b.save();
...
o;return this},getNormalizedSize:function(o,c,m){if(m&&c&&o.width>o.height&&o.width/o.height<c/m){normalizedWidth=~~(o.width*m/o.height);normalizedHeight=m}else if(m&&(o.height==o.width||o.height>o.width||o.height>m)){normalizedWidth=~~(o.width*m/o.height);normalizedHeight=m}else if(c&&c<o.width){normalizedHeight=~~(o.height*c/o.width);normalizedWidth=c}else{normalizedWidth=o.width;normalizedHeight=o.height}return{width:normalizedWidth,height:normalizedHeight}},getOriginalSize:function(){var o=this.getElement();
return{width:o.width,height:o.height}},setBorderVisibility:function(o){this._resetWidthHeight();this._adjustWidthHeightToBorders(o);this.setCoords()},setCornersVisibility:function(o){this.cornervisibility=!!o},render:function(o,c){o.save();c||this.transform(o);this._render(o);if(this.active&&!c){this.drawBorders(o);this.hideCorners||this.drawCorners(o)}o.restore()},toObject:function(){return g(this.callSuper("toObject"),{src:this.getSrc()})},getSrc:function(){return this.getElement().src},toString:function(){return'#<fabric.Image: { src: "'+
this.getSrc()+'" }>'},clone:function(o){this.constructor.fromObject(this.toObject(),o)},toGrayscale:function(o){if(!this.__isGrayscaled){var c=this.getElement(),m=document.createElement("canvas"),k=document.createElement("img"),e=this;m.width=c.width;m.height=c.height;m.getContext("2d").drawImage(c,0,0);fabric.Element.toGrayscale(m);k.onload=function(){e.setElement(k);o&&o();k.onload=m=c=imageData=null};k.width=c.width;k.height=c.height;k.src=m.toDataURL("image/png");this.__isGrayscaled=true;return this}},
_render:function(o){var c=this.getOriginalSize();o.drawImage(this.getElement(),-c.width/2,-c.height/2,c.width,c.height)},_adjustWidthHeightToBorders:function(o){if(o){this.currentBorder=this.borderwidth;this.width+=2*this.currentBorder;this.height+=2*this.currentBorder}else this.currentBorder=0},_resetWidthHeight:function(){var o=this.getElement();this.set("width",o.width);this.set("height",o.height)},_initElement:function(o){this.setElement(fabric.util.getById(o));fabric.util.addClass(this.getElement(),
fabric.Image.CSS_CANVAS)},_initConfig:function(o){this.setOptions(o);this._setBorder();this._setWidthHeight(o)},_setBorder:function(){this.currentBorder=this.bordervisibility?this.borderwidth:0},_setWidthHeight:function(){var o=2*this.currentBorder;this.width=(this.getElement().width||0)+o;this.height=(this.getElement().height||0)+o},complexity:function(){return 1}});fabric.Image.CSS_CANVAS="canvas-img";fabric.Image.fromObject=function(o,c){var m=document.createElement("img"),k=o.src;if(o.width)m.width=
o.width;if(o.height)m.height=o.height;m.onload=function(){c&&c(new fabric.Image(m,o));m=m.onload=null};m.src=k};fabric.Image.fromURL=function(o,c,m){var k=document.createElement("img");k.onload=function(){c&&c(new fabric.Image(k,m));k=k.onload=null};k.src=o}}else console.warn("fabric.Object is required for fabric.Image initialization")})();
