...
this.scaleY);a.lineWidth=1/this.borderScaleFactor;a.scale(c,q);c=this.getWidth();q=this.getHeight();a.strokeRect(Math.floor(-(c/2)-h)+0.5,Math.floor(-(q/2)-h)+0.5,Math.floor(c+n),Math.floor(q+n));a.restore();return this},drawCorners:function(a){var c=this.options.cornersize,h=c/2,n=this.options.padding,q=-(this.width/2),r=-(this.height/2),s=c/this.scaleX,x=c/this.scaleY,t=(n+h)/this.scaleY,v=(n+h)/this.scaleX,u=(n+h-c)/this.scaleX;n=(n+h-c)/this.scaleY;a.save();a.globalAlpha=this.isMoving?this.options.borderOpacityWhenMoving:
1;a.fillStyle=this.options.cornerColor;c=q-v;h=r-t;a.fillRect(c,h,s,x);c=q+this.width-v;h=r-t;a.fillRect(c,h,s,x);c=q-v;h=r+this.height+n;a.fillRect(c,h,s,x);c=q+this.width+u;h=r+this.height+n;a.fillRect(c,h,s,x);c=q+this.width/2-v;h=r-t;a.fillRect(c,h,s,x);c=q+this.width/2-v;h=r+this.height+n;a.fillRect(c,h,s,x);c=q+this.width+u;h=r+this.height/2-t;a.fillRect(c,h,s,x);c=q-v;h=r+this.height/2-t;a.fillRect(c,h,s,x);a.restore();return this},clone:function(a){if(this.constructor.fromObject)return this.constructor.fromObject(this.toObject(),
...
o;return this},getNormalizedSize:function(o,d,m){if(m&&d&&o.width>o.height&&o.width/o.height<d/m){normalizedWidth=Math.floor(o.width*m/o.height);normalizedHeight=m}else if(m&&(o.height==o.width||o.height>o.width||o.height>m)){normalizedWidth=Math.floor(o.width*m/o.height);normalizedHeight=m}else if(d&&d<o.width){normalizedHeight=Math.floor(o.height*d/o.width);normalizedWidth=d}else{normalizedWidth=o.width;normalizedHeight=o.height}return{width:normalizedWidth,height:normalizedHeight}},getOriginalSize:function(){var o=
this.getElement();return{width:o.width,height:o.height}},setBorderVisibility:function(o){this._resetWidthHeight();this._adjustWidthHeightToBorders(o);this.setCoords()},setCornersVisibility:function(o){this.cornervisibility=!!o},render:function(o,d){o.save();d||this.transform(o);this._render(o);if(this.active&&!d){this.drawBorders(o);this.hideCorners||this.drawCorners(o)}o.restore()},toObject:function(){return g(this.callSuper("toObject"),{src:this.getSrc()})},getSrc:function(){return this.getElement().src},
toString:function(){return'#<fabric.Image: { src: "'+this.getSrc()+'" }>'},clone:function(o){this.constructor.fromObject(this.toObject(),o)},toGrayscale:function(o){if(!this.__isGrayscaled){var d=this.getElement(),m=document.createElement("canvas"),k=document.createElement("img"),e=this;m.width=d.width;m.height=d.height;m.getContext("2d").drawImage(d,0,0);fabric.Element.toGrayscale(m);k.onload=function(){e.setElement(k);o&&o();k.onload=m=d=imageData=null};k.width=d.width;k.height=d.height;k.src=m.toDataURL("image/png");
this.__isGrayscaled=true;return this}},_render:function(o){var d=this.getOriginalSize();o.drawImage(this.getElement(),-d.width/2,-d.height/2,d.width,d.height)},_adjustWidthHeightToBorders:function(o){if(o){this.currentBorder=this.borderwidth;this.width+=2*this.currentBorder;this.height+=2*this.currentBorder}else this.currentBorder=0},_resetWidthHeight:function(){var o=this.getElement();this.set("width",o.width);this.set("height",o.height)},_initElement:function(o){this.setElement(fabric.util.getById(o));
fabric.util.addClass(this.getElement(),fabric.Image.CSS_CANVAS)},_initConfig:function(o){this.setOptions(o);this._setBorder();this._setWidthHeight(o)},_setBorder:function(){this.currentBorder=this.bordervisibility?this.borderwidth:0},_setWidthHeight:function(){var o=2*this.currentBorder;this.width=(this.getElement().width||0)+o;this.height=(this.getElement().height||0)+o}});fabric.Image.CSS_CANVAS="canvas-img";fabric.Image.fromObject=function(o,d){var m=document.createElement("img"),k=o.src;if(o.width)m.width=
o.width;if(o.height)m.height=o.height;m.onload=function(){d&&d(new fabric.Image(m,o));m=m.onload=null};m.src=k};fabric.Image.fromURL=function(o,d,m){var k=document.createElement("img");k.onload=function(){d&&d(new fabric.Image(k,m));k=k.onload=null};k.src=o}}else console.warn("fabric.Object is required for fabric.Image initialization")})();
