...
(function(){function g(h){return h<10?"0"+h:h}function p(h){k.lastIndex=0;return k.test(h)?'"'+h.replace(k,function(o){var q=a[o];return typeof q==="string"?q:"\\u"+("0000"+o.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+h+'"'}function c(h,o){var q,r,t,x,u=e,w,v=o[h];if(v&&typeof v==="object"&&typeof v.toJSON==="function")v=v.toJSON(h);if(typeof d==="function")v=d.call(o,h,v);switch(typeof v){case "string":return p(v);case "number":return isFinite(v)?String(v):"null";case "boolean":case "null":return String(v);
case "object":if(!v)return"null";e+=b;w=[];if(Object.prototype.toString.apply(v)==="[object Array]"){x=v.length;for(q=0;q<x;q+=1)w[q]=c(q,v)||"null";t=w.length===0?"[]":e?"[\n"+e+w.join(",\n"+e)+"\n"+u+"]":"["+w.join(",")+"]";e=u;return t}if(d&&typeof d==="object"){x=d.length;for(q=0;q<x;q+=1){r=d[q];if(typeof r==="string")if(t=c(r,v))w.push(p(r)+(e?": ":":")+t)}}else for(r in v)if(Object.hasOwnProperty.call(v,r))if(t=c(r,v))w.push(p(r)+(e?": ":":")+t);t=w.length===0?"{}":e?"{\n"+e+w.join(",\n"+e)+
"\n"+u+"}":"{"+w.join(",")+"}";e=u;return t}}if(typeof Date.prototype.toJSON!=="function"){Date.prototype.toJSON=function(){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+g(this.getUTCMonth()+1)+"-"+g(this.getUTCDate())+"T"+g(this.getUTCHours())+":"+g(this.getUTCMinutes())+":"+g(this.getUTCSeconds())+"Z":null};String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(){return this.valueOf()}}var m=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
...
{"":h})};if(typeof JSON.parse!=="function")JSON.parse=function(h,o){function q(t,x){var u,w,v=t[x];if(v&&typeof v==="object")for(u in v)if(Object.hasOwnProperty.call(v,u)){w=q(v,u);if(w!==undefined)v[u]=w;else delete v[u]}return o.call(t,x,v)}var r;h=String(h);m.lastIndex=0;if(m.test(h))h=h.replace(m,function(t){return"\\u"+("0000"+t.charCodeAt(0).toString(16)).slice(-4)});if(/^[\],:{}\s]*$/.test(h.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
...
emptyFunction;return b.prototype.constructor=b}})();(function(){function k(u){var w=Array.prototype.slice.call(arguments,1),v,A,f=w.length;for(A=0;A<f;A++){v=typeof u[w[A]];if(!/^(?:function|object|unknown)$/.test(v))return false}return true}function e(u,w){return function(v){w.call(d(u),v||window.event)}}function b(u,w){return function(v){if(t[u]&&t[u][w])for(var A=t[u][w],f=0,l=A.length;f<l;f++)A[f].call(this,v||window.event)}}var a=function(){if(typeof document.documentElement.uniqueID!=="undefined")return function(w){return w.uniqueID};
var u=0;return function(w){return w.__uniqueID||(w.__uniqueID="uniqueID__"+u++)}}(),d,h;(function(){var u={};d=function(w){return u[w]};h=function(w,v){u[w]=v}})();var o=k(document.documentElement,"addEventListener","removeEventListener")&&k(window,"addEventListener","removeEventListener"),q=k(document.documentElement,"attachEvent","detachEvent")&&k(window,"attachEvent","detachEvent"),r={},t={};if(o){addListener=function(u,w,v){u.addEventListener(w,v,false)};removeListener=function(u,w,v){u.removeEventListener(w,
v,false)}}else if(q){addListener=function(u,w,v){var A=a(u);h(A,u);r[A]||(r[A]={});r[A][w]||(r[A][w]=[]);v={handler:v,wrappedHandler:e(A,v)};r[A][w].push(v);u.attachEvent("on"+w,v.wrappedHandler)};removeListener=function(u,w,v){var A=a(u),f;if(r[A]&&r[A][w])for(var l=0,n=r[A][w].length;l<n;l++)if((f=r[A][w][l])&&f.handler===v){u.detachEvent("on"+w,f.wrappedHandler);r[A][w][l]=null}}}else{addListener=function(u,w,v){var A=a(u);t[A]||(t[A]={});if(!t[A][w]){t[A][w]=[];var f=u["on"+w];f&&t[A][w].push(f);
u["on"+w]=b(A,w)}t[A][w].push(v)};removeListener=function(u,w,v){u=a(u);if(t[u]&&t[u][w]){w=t[u][w];u=0;for(var A=w.length;u<A;u++)w[u]===v&&w.splice(u,1)}}}c.util.addListener=addListener;c.util.removeListener=removeListener;var x={};c.util.observeEvent=function(u,w){x[u]||(x[u]=[]);x[u].push(w)};c.util.fireEvent=function(u,w){var v=x[u];if(v)for(var A=0,f=v.length;A<f;A++)v[A]({memo:w})};c.util.getPointer=function(u){var w=document.documentElement,v=document.body||{scrollLeft:0},A=document.documentElement,
f=document.body||{scrollTop:0};return{x:u.pageX||u.clientX+(w.scrollLeft||v.scrollLeft)-(w.clientLeft||0),y:u.pageY||u.clientY+(A.scrollTop||f.scrollTop)-(A.clientTop||0)}}})(this);(function(){var k=document.createElement("div"),e=typeof k.style.filter==="string",b=/alpha\s*\(\s*opacity\s*=\s*([^\)]+)\)/,a=function(d){return d};if(typeof k.style.opacity==="string")a=function(d,h){d.style.opacity=h;return d};else if(e)a=function(d,h){var o=d.style;if(d.currentStyle&&!d.currentStyle.hasLayout)o.zoom=
...
h,o=k.onChange||function(){},q=k.easing||function(w){return-Math.cos(w*Math.PI)/2+0.5},r="startValue"in k?k.startValue:0,t="endValue"in k?k.endValue:100,x=r>t;k.onStart&&k.onStart();var u=setInterval(function(){d=+new Date;h=d>a?1:(d-e)/b;o(x?r-(r-t)*q(h):r+(t-r)*q(h));if(d>a){clearInterval(u);k.onComplete&&k.onComplete()}},10)};(function(){function k(){}var e=function(){for(var b=[function(){return new ActiveXObject("Microsoft.XMLHTTP")},function(){return new ActiveXObject("Msxml2.XMLHTTP")},function(){return new ActiveXObject("Msxml2.XMLHTTP.3.0")},
...
return function(a,d){if(a){var h=g.util.toArray(a.getElementsByTagName("*")).filter(function(u){var w;if(w=e.test(u.tagName)){a:{for(u=u;u&&(u=u.parentNode);)if(u.nodeName==="pattern"){u=true;break a}u=false}w=!u}return w});if(!(!h||h&&!h.length)){var o=a.getAttribute("viewBox"),q=a.getAttribute("width"),r=a.getAttribute("height"),t=null,x=null;if(o&&(o=o.match(b))){parseInt(o[1],10);parseInt(o[2],10);t=parseInt(o[3],10);x=parseInt(o[4],10)}t=q?parseFloat(q):t;x=r?parseFloat(r):x;o={width:t,height:x};
...
{target:l});l._scaling=false}for(var n=this._objects.length;n--;)this._objects[n].setCoords();if(l.hasStateChanged()){l.isMoving=false;e("object:modified",{target:l})}}this._currentTransform=null;this._groupSelector&&this._findSelectedObjects(f);if(n=this.getActiveGroup()){n.hasStateChanged()&&n.containsPoint(this.getPointer(f))&&e("group:modified",{target:n});n.setObjectsCoords();n.set("isMoving",false);this._setCursor("default")}this._groupSelector=null;this.renderAll();this._setCursorFromEvent(f,
l);this._setCursor("");var s=this;setTimeout(function(){s._setCursorFromEvent(f,l)},50)},shouldClearSelection:function(f){var l=this.findTarget(f),n=this.getActiveGroup();return!l||l&&n&&!n.contains(l)&&n!==l&&!f.shiftKey},__onMouseDown:function(f){if(!this._currentTransform){var l=this.findTarget(f),n=this.getPointer(f),s=this.getActiveGroup();if(this.shouldClearSelection(f)){this._groupSelector={ex:n.x,ey:n.y,top:0,left:0};this.deactivateAllWithDispatch()}else{l.saveState();l._findTargetCorner(f,
this._offset)&&this.onBeforeScaleRotate(l);this._setupCurrentTransform(f,l);if(f.shiftKey&&(s||this.getActiveObject()))this._handleGroupLogic(f,l);else{l!==this.getActiveGroup()&&this.deactivateAll();this.setActiveObject(l)}}this.renderAll()}},getElement:function(){return this._element},deactivateAllWithDispatch:function(){var f=this.getActiveGroup();f&&e("before:group:destroyed",{target:f});this.deactivateAll();f&&e("after:group:destroyed");e("selection:cleared");return this},_setupCurrentTransform:function(f,
l){var n="drag",s,y=b(f);if(s=l._findTargetCorner(f,this._offset))n=s==="ml"||s==="mr"?"scaleX":s==="mt"||s==="mb"?"scaleY":"rotate";this._currentTransform={target:l,action:n,scaleX:l.scaleX,scaleY:l.scaleY,offsetX:y.x-l.left,offsetY:y.y-l.top,ex:y.x,ey:y.y,left:l.left,top:l.top,theta:l.theta,width:l.width*l.scaleX};this._currentTransform.original={left:l.left,top:l.top}},_handleGroupLogic:function(f,l){if(l.isType("group")){l=this.findTarget(f,true);if(!l||l.isType("group"))return}var n=this.getActiveGroup();
if(n){if(n.contains(l)){n.remove(l);l.setActive(false);n.size()===1&&this.removeActiveGroup()}else n.add(l);e("group:selected",{target:n});n.setActive(true)}else{if(this._activeObject)if(l!==this._activeObject){this.setActiveGroup(new fabric.Group([this._activeObject,l]));n=this.getActiveGroup()}l.setActive(true)}n&&n.saveCoords()},__onMouseMove:function(f){var l=this._groupSelector;if(l!==null){var n=b(f);l.left=n.x-this._offset.left-l.ex;l.top=n.y-this._offset.top-l.ey;this.renderTop()}else if(this._currentTransform){n=
...
this._objects.length;f--;)this._objects[f].active||this._objects[f].setActive(false);n.cursor="default"}}},_translateObject:function(f,l){var n=this._currentTransform.target;n.lockHorizontally||n.set("left",f-this._currentTransform.offsetX);n.lockVertically||n.set("top",l-this._currentTransform.offsetY)},_scaleObject:function(f,l,n){var s=this._currentTransform,y=this._offset,z=s.target;if(!z.lockScaling){var B=q(r(s.ey-s.top-y.top,2)+r(s.ex-s.left-y.left,2));f=q(r(l-s.top-y.top,2)+r(f-s.left-y.left,
2));z._scaling=true;if(n)if(n==="x")z.set("scaleX",s.scaleX*f/B);else n==="y"&&z.set("scaleY",s.scaleY*f/B);else{z.set("scaleX",s.scaleX*f/B);z.set("scaleY",s.scaleY*f/B)}}},_rotateObject:function(f,l){var n=this._currentTransform,s=this._offset;if(!n.target.lockRotation){var y=t(n.ey-n.top-s.top,n.ex-n.left-s.left);s=t(l-n.top-s.top,f-n.left-s.left);n.target.set("theta",s-y+n.theta)}},_setCursor:function(f){this._element.style.cursor=f},_setCursorFromEvent:function(f,l){var n=this._element.style;
if(l){var s=this.getActiveGroup();if(s=!!l._findTargetCorner&&(!s||!s.contains(l))&&l._findTargetCorner(f,this._offset))if(s in A)n.cursor=A[s];else{n.cursor="default";return false}else n.cursor="move"}else{n.cursor="default";return false}return true},_draw:function(f,l){l&&l.render(f)},_drawSelection:function(){var f=this._groupSelector,l=f.left,n=f.top,s=x(l),y=x(n);this.contextTop.fillStyle=this.selectionColor;this.contextTop.fillRect(f.ex-(l>0?0:-l),f.ey-(n>0?0:-n),s,y);this.contextTop.lineWidth=
this.selectionLineWidth;this.contextTop.strokeStyle=this.selectionBorderColor;this.contextTop.strokeRect(f.ex+0.5-(l>0?0:s),f.ey+0.5-(n>0?0:y),s,y)},_findSelectedObjects:function(){var f=[],l=this._groupSelector.ex,n=this._groupSelector.ey,s=l+this._groupSelector.left,y=n+this._groupSelector.top,z=new fabric.Point(u(l,s),u(n,y));n=new fabric.Point(w(l,s),w(n,y));s=0;for(y=this._objects.length;s<y;++s){l=this._objects[s];if(l.intersectsWithRect(z,n)||l.isContainedWithinRect(z,n)){l.setActive(true);
...
0,this._config.width,this._config.height);return this},clear:function(){this._objects.length=0;this.clearContext(this.contextTop);this.clearContext(this.contextContainer);this.renderAll();return this},renderAll:function(f){var l=f?this.contextTop:this.contextContainer;this.clearContext(this.contextTop);f||this.clearContext(l);f=this._objects.length;var n=this.getActiveGroup(),s=new Date;if(f)for(var y=0;y<f;++y)if(!n||n&&!n.contains(this._objects[y]))this._draw(l,this._objects[y]);n&&this._draw(this.contextTop,
n);this.overlayImage&&this.contextTop.drawImage(this.overlayImage,0,0);this.onFpsUpdate(~~(1E3/(new Date-s)));this.afterRender&&this.afterRender();return this},renderTop:function(){this.clearContext(this.contextTop);this.overlayImage&&this.contextTop.drawImage(this.overlayImage,0,0);this._groupSelector&&this._drawSelection();var f=this.getActiveGroup();f&&f.render(this.contextTop);this.afterRender&&this.afterRender();return this},containsPoint:function(f,l){var n=this.getPointer(f),s=this._normalizePointer(l,
n);n=s.x;s=s.y;var y=l._getImageLines(l.oCoords);if((n=l._findCrossPoints(n,s,y))&&n%2===1||l._findTargetCorner(f,this._offset))return true;return false},_normalizePointer:function(f,l){var n=this.getActiveGroup(),s=l.x,y=l.y;if(n&&f.type!=="group"&&n.contains(f)){s-=n.left;y-=n.top}return{x:s,y:y}},findTarget:function(f,l){var n;this.getPointer(f);var s=this.getActiveGroup();if(s&&!l&&this.containsPoint(f,s))return n=s;for(s=this._objects.length;s--;)if(this.containsPoint(f,this._objects[s])){this.relatedTarget=
n=this._objects[s];break}return n},toDataURL:function(f){var l;f||(f="png");if(f==="jpeg"||f==="png"){this.renderAll(true);l=this.getElement().toDataURL("image/"+f);this.renderAll()}return l},toDataURLWithMultiplier:function(f,l){var n=this.getWidth(),s=this.getHeight(),y=n*l,z=s*l,B=this.getActiveObject();this.setWidth(y).setHeight(z);this.contextTop.scale(l,l);B&&this.deactivateAll().renderAll();y=this.toDataURL(f);this.contextTop.scale(1/l,1/l);this.setWidth(n).setHeight(s);B&&this.setActiveObject(B);
this.renderAll();return y},getPointer:function(f){f=b(f);return{x:f.x-this._offset.left,y:f.y-this._offset.top}},getCenter:function(){return{top:this.getHeight()/2,left:this.getWidth()/2}},centerObjectH:function(f){f.set("left",this.getCenter().left);this.renderAll();return this},fxCenterObjectH:function(f,l){l=l||{};var n=function(){},s=l.onComplete||n,y=l.onChange||n,z=this;fabric.util.animate({startValue:f.get("left"),endValue:this.getCenter().left,duration:this.FX_DURATION,onChange:function(B){f.set("left",
B);z.renderAll();y()},onComplete:function(){f.setCoords();s()}});return this},centerObjectV:function(f){f.set("top",this.getCenter().top);this.renderAll();return this},fxCenterObjectV:function(f,l){l=l||{};var n=function(){},s=l.onComplete||n,y=l.onChange||n,z=this;fabric.util.animate({startValue:f.get("top"),endValue:this.getCenter().top,duration:this.FX_DURATION,onChange:function(B){f.set("top",B);z.renderAll();y()},onComplete:function(){f.setCoords();s()}});return this},straightenObject:function(f){f.straighten();
this.renderAll();return this},fxStraightenObject:function(f){f.fxStraighten({onChange:this.renderAll.bind(this)});return this},toDatalessJSON:function(){return this.toDatalessObject()},toObject:function(){return this._toObjectMethod("toObject")},toDatalessObject:function(){return this._toObjectMethod("toDatalessObject")},_toObjectMethod:function(f){return{objects:this._objects.map(function(l){if(!this.includeDefaultValues){var n=l.includeDefaultValues;l.includeDefaultValues=false}var s=l[f]();if(!this.includeDefaultValues)l.includeDefaultValues=
n;return s},this),background:this.backgroundColor}},isEmpty:function(){return this._objects.length===0},loadFromJSON:function(f,l){if(f){var n=JSON.parse(f);if(!(!n||n&&!n.objects)){this.clear();var s=this;this._enlivenObjects(n.objects,function(){s.backgroundColor=n.background;l&&l()});return this}}},_enlivenObjects:function(f,l){var n=0,s=f.filter(function(z){return z.type==="image"}).length,y=this;f.forEach(function(z){if(z.type)switch(z.type){case "image":case "font":fabric[m(z.type)].fromObject(z,
function(C){y.add(C);++n===s&&l&&l()});break;default:var B=fabric[k(m(z.type))];B&&B.fromObject&&y.add(B.fromObject(z));break}});s===0&&l&&l()},loadFromDatalessJSON:function(f,l){if(f){var n=typeof f==="string"?JSON.parse(f):f;if(!(!n||n&&!n.objects)){this.clear();this.backgroundColor=n.background;this._enlivenDatalessObjects(n.objects,l)}}},_enlivenDatalessObjects:function(f,l){function n(C,E){s.insertAt(C,E);C.setCoords();++y===z&&l&&l()}var s=this,y=0,z=f.length;z===0&&l&&l();try{f.forEach(function(C,
E){var G=C.paths?"paths":"path",F=C[G];delete C[G];if(typeof F!=="string")switch(C.type){case "image":case "text":fabric[m(C.type)].fromObject(C,function(D){n(D,E)});break;default:(G=fabric[k(m(C.type))])&&G.fromObject&&n(G.fromObject(C),E);break}else if(C.type==="image")s.loadImageFromURL(F,function(D){D.setSourcePath(F);c(D,C);D.setAngle(C.angle);n(D,E)});else if(C.type==="text"){C.path=F;var H=fabric.Text.fromObject(C);fabric.util.getScript(F,function(){Object.prototype.toString.call(g.opera)===
"[object Opera]"?setTimeout(function(){n(H,E)},500):n(H,E)})}else s.loadSVGFromURL(F,function(D){D=D.length>1?new fabric.PathGroup(D,C):D[0];D.setSourcePath(F);if(!(D instanceof fabric.PathGroup)){c(D,C);typeof C.angle!=="undefined"&&D.setAngle(C.angle)}n(D,E)})},this)}catch(B){console.log(B.message)}},loadImageFromURL:function(){var f={};return function(l,n){function s(){var B=p.getElementById(f[l]);B.width&&B.height?n(new fabric.Image(B)):setTimeout(s,50)}var y=this;if(f[l])s();else{var z=new Image;
z.onload=function(){z.onload=null;y._resizeImageToFit(z);var B=new fabric.Image(z);n(B)};z.className="canvas-img-clone";z.src=l;if(this.shouldCacheImages)f[l]=Element.identify(z);p.body.appendChild(z)}}}(),loadSVGFromURL:function(f,l){function n(z){if(z=z.responseXML)(z=z.documentElement)&&fabric.parseSVGDocument(z,function(B,C){y.cache.set(f,{objects:B.invoke("toObject"),options:C});l(B,C)})}function s(){console.log("ERROR!")}var y=this;f=f.replace(/^\n\s*/,"").replace(/\?.*$/,"").trim();this.cache.has(f,
function(z){if(z)y.cache.get(f,function(B){B=y._enlivenCachedObject(B);l(B.objects,B.options)});else new Ajax.Request(f,{method:"get",onComplete:n,onFailure:s})})},_enlivenCachedObject:function(f){var l=f.objects;f=f.options;l=l.map(function(n){return fabric[m(n.type)].fromObject(n)});return{objects:l,options:f}},remove:function(f){d(this._objects,f);this.renderAll();return f},fxRemove:function(f,l){var n=this;f.fxRemove({onChange:this.renderAll.bind(this),onComplete:function(){n.remove(f);typeof l===
"function"&&l()}});return this},sendToBack:function(f){d(this._objects,f);this._objects.unshift(f);return this.renderAll()},bringToFront:function(f){d(this._objects,f);this._objects.push(f);return this.renderAll()},sendBackwards:function(f){var l=this._objects.indexOf(f),n=l;if(l!==0){for(l=l-1;l>=0;--l)if(f.intersectsWithObject(this._objects[l])){n=l;break}d(this._objects,f);this._objects.splice(n,0,f)}return this.renderAll()},bringForward:function(f){var l=this.getObjects(),n=l.indexOf(f),s=n;if(n!==
l.length-1){n=n+1;for(var y=this._objects.length;n<y;++n)if(f.intersectsWithObject(l[n])){s=n;break}d(l,f);l.splice(s,0,f)}this.renderAll()},setActiveObject:function(f){this._activeObject&&this._activeObject.setActive(false);this._activeObject=f;f.setActive(true);this.renderAll();e("object:selected",{target:f});return this},getActiveObject:function(){return this._activeObject},removeActiveObject:function(){this._activeObject&&this._activeObject.setActive(false);this._activeObject=null;return this},
setActiveGroup:function(f){this._activeGroup=f;return this},getActiveGroup:function(){return this._activeGroup},removeActiveGroup:function(){var f=this.getActiveGroup();f&&f.destroy();return this.setActiveGroup(null)},item:function(f){return this.getObjects()[f]},deactivateAll:function(){for(var f=this.getObjects(),l=0,n=f.length;l<n;l++)f[l].setActive(false);this.removeActiveGroup();this.removeActiveObject();return this},complexity:function(){return this.getObjects().reduce(function(f,l){f+=l.complexity?
l.complexity():0;return f},0)},dispose:function(){this.clear();o(this.getElement(),"mousedown",this._onMouseDown);o(p,"mouseup",this._onMouseUp);o(p,"mousemove",this._onMouseMove);o(g,"resize",this._onResize);return this},clone:function(f){var l=p.createElement("canvas");l.width=this.getWidth();l.height=this.getHeight();var n=this.__clone||(this.__clone=new fabric.Element(l));return n.loadFromJSON(this.toJSON(),function(){f&&f(n)})},_toDataURL:function(f,l){this.clone(function(n){l(n.toDataURL(f))})},
_toDataURLWithMultiplier:function(f,l,n){this.clone(function(s){n(s.toDataURLWithMultiplier(f,l))})},_resizeImageToFit:function(f){var l=f.width||f.offsetWidth,n=this.getWidth()/l;if(l)f.width=l*n},cache:{has:function(f,l){l(false)},get:function(){},set:function(){}}});fabric.Element.prototype.toString=function(){return"#<fabric.Element ("+this.complexity()+"): { objects: "+this.getObjects().length+" }>"};c(fabric.Element,{EMPTY_JSON:'{"objects": [], "background": "white"}',toGrayscale:function(f){var l=
f.getContext("2d");f=l.getImageData(0,0,f.width,f.height);var n=f.data,s=f.width,y=f.height,z,B;for(i=0;i<s;i++)for(j=0;j<y;j++){z=i*4*y+j*4;B=(n[z]+n[z+1]+n[z+2])/3;n[z]=B;n[z+1]=B;n[z+2]=B}l.putImageData(f,0,0)},supports:function(f){var l=p.createElement("canvas");if(!l||!l.getContext)return null;var n=l.getContext("2d");if(!n)return null;switch(f){case "getImageData":return typeof n.getImageData!=="undefined";case "toDataURL":return typeof l.toDataURL!=="undefined";default:return null}}});fabric.Element.prototype.toJSON=
...
left:0,width:100,height:100,scaleX:1,scaleY:1,flipX:false,flipY:false,theta:0,opacity:1,angle:0,cornersize:10,padding:0,borderColor:"rgba(102,153,255,0.75)",cornerColor:"rgba(102,153,255,0.5)",fill:"rgb(0,0,0)",overlayFill:null,stroke:null,strokeWidth:1,fillRule:"source-over",borderOpacityWhenMoving:0.4,borderScaleFactor:1,transformMatrix:null},callSuper:function(a){var d=this.constructor.superclass.prototype[a];return arguments.length>1?d.apply(this,b.call(arguments,1)):d.call(this)},initialize:function(a){this.setOptions(a);
...
this.NUM_FRACTION_DIGITS),scaleY:m(this.scaleY,this.NUM_FRACTION_DIGITS),angle:m(this.getAngle(),this.NUM_FRACTION_DIGITS),flipX:this.flipX,flipY:this.flipY,opacity:m(this.opacity,this.NUM_FRACTION_DIGITS)};this.includeDefaultValues||(a=this._removeDefaultValues(a));return a},toDatalessObject:function(){return this.toObject()},_removeDefaultValues:function(a){var d=g.Object.prototype.options;this.stateProperties.forEach(function(h){a[h]===d[h]&&delete a[h]});return a},isActive:function(){return!!this.active},
setActive:function(a){this.active=!!a;return this},toString:function(){return"#<fabric."+k(this.type)+">"},set:function(a,d){if((a==="scaleX"||a==="scaleY")&&d<this.MIN_SCALE_LIMIT)d=this.MIN_SCALE_LIMIT;if(a==="angle")this.setAngle(d);else this[a]=d;return this},toggle:function(a){var d=this.get(a);typeof d==="boolean"&&this.set(a,!d);return this},setSourcePath:function(a){this.sourcePath=a;return this},get:function(a){return a==="angle"?this.getAngle():this[a]},render:function(a,d){if(!(this.width===
0||this.height===0)){a.save();var h=this.transformMatrix;h&&a.setTransform(h[0],h[1],h[2],h[3],h[4],h[5]);d||this.transform(a);if(this.stroke){a.lineWidth=this.strokeWidth;a.strokeStyle=this.stroke}if(this.overlayFill)a.fillStyle=this.overlayFill;else if(this.fill)a.fillStyle=this.fill;this._render(a);if(this.active&&!d){this.drawBorders(a);this.hideCorners||this.drawCorners(a)}a.restore()}},getWidth:function(){return this.width*this.scaleX},getHeight:function(){return this.height*this.scaleY},scale:function(a){this.scaleY=
...
this.scaleY);a.lineWidth=1/this.borderScaleFactor;a.scale(d,q);d=this.getWidth();q=this.getHeight();a.strokeRect(~~(-(d/2)-h)+0.5,~~(-(q/2)-h)+0.5,~~(d+o),~~(q+o));a.restore();return this},drawCorners:function(a){var d=this.options.cornersize,h=d/2,o=this.options.padding,q=-(this.width/2),r=-(this.height/2),t=d/this.scaleX,x=d/this.scaleY,u=(o+h)/this.scaleY,w=(o+h)/this.scaleX,v=(o+h-d)/this.scaleX;o=(o+h-d)/this.scaleY;a.save();a.globalAlpha=this.isMoving?this.options.borderOpacityWhenMoving:1;
a.fillStyle=this.options.cornerColor;d=q-w;h=r-u;a.fillRect(d,h,t,x);d=q+this.width-w;h=r-u;a.fillRect(d,h,t,x);d=q-w;h=r+this.height+o;a.fillRect(d,h,t,x);d=q+this.width+v;h=r+this.height+o;a.fillRect(d,h,t,x);d=q+this.width/2-w;h=r-u;a.fillRect(d,h,t,x);d=q+this.width/2-w;h=r+this.height+o;a.fillRect(d,h,t,x);d=q+this.width+v;h=r+this.height/2-u;a.fillRect(d,h,t,x);d=q-w;h=r+this.height/2-u;a.fillRect(d,h,t,x);a.restore();return this},clone:function(a){if(this.constructor.fromObject)return this.constructor.fromObject(this.toObject(),
...
[],b,a,d=0,h=this.path.length;d<h;d++){b=this.path[d];a=b.slice(1).trim().replace(/(\d)-/g,"$1###-").split(/\s|,|###/);e.push([b.charAt(0)].concat(a.map(parseFloat)))}return e},_parseDimensions:function(){function e(v){if(v[0]==="H")return v[1];return v[v.length-2]}function b(v){if(v[0]==="V")return v[1];return v[v.length-1]}var a=[],d=[],h,o,q=false,r,t;this.path.forEach(function(v,A){if(v[0]!=="H")h=A===0?e(v):e(this.path[A-1]);if(v[0]!=="V")o=A===0?b(v):b(this.path[A-1]);if(v[0]===v[0].toLowerCase())q=
true;r=q?h+e(v):v[0]==="V"?h:e(v);t=q?o+b(v):v[0]==="H"?o:b(v);var f=parseInt(r,10);isNaN(f)||a.push(f);f=parseInt(t,10);isNaN(f)||d.push(f)},this);var x=p(a),u=p(d),w=deltaY=0;x={top:u-deltaY,left:x-w,bottom:c(d)-deltaY,right:c(a)-w};x.width=x.right-x.left;x.height=x.bottom-x.top;return x}});g.Path.fromObject=function(e){return new g.Path(e.path,e)};var k=g.Path.ATTRIBUTE_NAMES="d fill fill-opacity fill-rule stroke stroke-width transform".split(" ");g.Path.fromElement=function(e,b){var a=g.parseAttributes(e,
