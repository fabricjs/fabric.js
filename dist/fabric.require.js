...
(function(global) {
    ...
    function makeEdgeToOriginGetter(propertyNames, originValues) {
        var origin = propertyNames.origin, toEdgeOne = propertyNames.toEdgeOne, toEdgeTwo = propertyNames.toEdgeTwo, dimension = propertyNames.dimension, nearest = originValues.nearest, center = originValues.center, farthest = originValues.farthest;
        return function() {
            switch (this[origin]) {
              case nearest:
                return Math.min(this[toEdgeOne], this[toEdgeTwo]);

              case center:
                return Math.min(this[toEdgeOne], this[toEdgeTwo]) + .5 * this[dimension];

              case farthest:
                return Math.max(this[toEdgeOne], this[toEdgeTwo]);
            }
        };
    }
})(typeof exports !== "undefined" ? exports : this);
...
(function() {
    ...
    fabric.IText = fabric.util.createClass(fabric.Text, fabric.Observable, {
        ...
        renderSelection: function(chars, boundaries) {
            ...
            ctx.save();
            ctx.fillStyle = this.selectionColor;
            var start = this.get2DCursorLocation(this.selectionStart), end = this.get2DCursorLocation(this.selectionEnd), startLine = start.lineIndex, endLine = end.lineIndex, textLines = this.text.split(this._reNewline), charIndex = start.charIndex - textLines[0].length;
