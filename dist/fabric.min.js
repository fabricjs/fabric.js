...
"keypress",this.onKeyPress.bind(this));!this._clickHandlerInitialized&&this.canvas&&(fabric.util.addListener(this.canvas.upperCanvasEl,"click",this.onClick.bind(this)),this._clickHandlerInitialized=!0)},_keysMap:{8:"removeChars",13:"insertNewline",37:"moveCursorLeft",38:"moveCursorUp",39:"moveCursorRight",40:"moveCursorDown",46:"forwardDelete"},_ctrlKeysMap:{65:"selectAll",67:"copy",86:"paste",88:"cut"},onPaste:function(e){this.insertChars(e.clipboardData.getData("text"))},onClick:function(){this.hiddenTextarea&&
this.hiddenTextarea.focus()},onKeyDown:function(e){if(this.isEditing){if(e.keyCode in this._keysMap)this[this._keysMap[e.keyCode]](e);else if(e.keyCode in this._ctrlKeysMap&&(e.ctrlKey||e.metaKey))this[this._ctrlKeysMap[e.keyCode]](e);else return;e.stopPropagation();this.canvas&&this.canvas.renderAll()}},forwardDelete:function(e){this.selectionStart===this.selectionEnd&&this.moveCursorRight(e);this.removeChars(e)},copy:function(){this.copiedText=this.getSelectedText();this.copiedStyles=this.getSelectionStyles(this.selectionStart,
this.selectionEnd)},paste:function(){this.copiedText&&this.insertChars(this.copiedText)},cut:function(e){this.copy();this.removeChars(e)},onKeyPress:function(e){!this.isEditing||e.metaKey||e.ctrlKey||8===e.keyCode||13===e.keyCode||(this.insertChars(String.fromCharCode(e.which)),e.stopPropagation())},getDownCursorOffset:function(e,c){var a=c?this.selectionEnd:this.selectionStart,d=this.text.split(this._reNewline),b=this.text.slice(0,a),g=this.text.slice(a),f=b.slice(b.lastIndexOf("\n")+1),b=g.match(/(.*)\n?/)[1],
g=(g.match(/.*\n(.*)\n?/)||{})[1]||"",h=this.get2DCursorLocation(a);if(h.lineIndex===d.length-1||e.metaKey)return this.text.length-a;for(var a=this._getWidthOfLine(this.ctx,h.lineIndex,d),l=this._getLineLeftOffset(a),k=h.lineIndex,m=0,n=f.length;m<n;m++)a=f[m],l+=this._getWidthOfChar(this.ctx,a,k,m);d=this._getIndexOnNextLine(h,g,l,d);return b.length+1+d},_getIndexOnNextLine:function(e,c,a,d){e=e.lineIndex+1;d=this._getWidthOfLine(this.ctx,e,d);var b=this._getLineLeftOffset(d),g=0,f;d=0;for(var h=
c.length;d<h;d++){var l=this._getWidthOfChar(this.ctx,c[d],e,d),b=b+l;if(b>a){f=!0;e=b;b=Math.abs(b-l-a);g=Math.abs(e-a)<b?d+1:d;break}}f||(g=c.length);return g},moveCursorDown:function(e){this.abortCursorAnimation();this._currentCursorOpacity=1;var c=this.getDownCursorOffset(e,"right"===this._selectionDirection);e.shiftKey?this.moveCursorDownWithShift(c):this.moveCursorDownWithoutShift(c);this.initDelayedCursor()},moveCursorDownWithoutShift:function(e){this._selectionDirection="right";this.selectionStart+=
e;this.selectionStart>this.text.length&&(this.selectionStart=this.text.length);this.selectionEnd=this.selectionStart},moveCursorDownWithShift:function(e){"left"===this._selectionDirection&&this.selectionStart!==this.selectionEnd?(this.selectionStart+=e,this._selectionDirection="left"):(this._selectionDirection="right",this.selectionEnd+=e,this.selectionEnd>this.text.length&&(this.selectionEnd=this.text.length))},getUpCursorOffset:function(e,c){var a=c?this.selectionEnd:this.selectionStart,d=this.get2DCursorLocation(a);
if(0===d.lineIndex||e.metaKey)return a;var b=this.text.slice(0,a),a=b.slice(b.lastIndexOf("\n")+1),b=(b.match(/\n?(.*)\n.*$/)||{})[1]||"",g=this.text.split(this._reNewline),f;f=this._getWidthOfLine(this.ctx,d.lineIndex,g);for(var h=this._getLineLeftOffset(f),l=d.lineIndex,k=0,m=a.length;k<m;k++)f=a[k],h+=this._getWidthOfChar(this.ctx,f,l,k);d=this._getIndexOnPrevLine(d,b,h,g);return b.length-d+a.length},_getIndexOnPrevLine:function(e,c,a,d){e=e.lineIndex-1;d=this._getWidthOfLine(this.ctx,e,d);var b=
this._getLineLeftOffset(d),g=0,f;d=0;for(var h=c.length;d<h;d++){var l=this._getWidthOfChar(this.ctx,c[d],e,d),b=b+l;if(b>a){f=!0;e=b;b=Math.abs(b-l-a);g=Math.abs(e-a)<b?d:d-1;break}}f||(g=c.length-1);return g},moveCursorUp:function(e){this.abortCursorAnimation();this._currentCursorOpacity=1;var c=this.getUpCursorOffset(e,"right"===this._selectionDirection);e.shiftKey?this.moveCursorUpWithShift(c):this.moveCursorUpWithoutShift(c);this.initDelayedCursor()},moveCursorUpWithShift:function(e){this.selectionStart!==
this.selectionEnd&&"right"===this._selectionDirection?(this.selectionEnd-=e,this._selectionDirection="right"):(this.selectionStart-=e,0>this.selectionStart&&(this.selectionStart=0),this._selectionDirection="left")},moveCursorUpWithoutShift:function(e){this.selectionStart===this.selectionEnd&&(this.selectionStart-=e);0>this.selectionStart&&(this.selectionStart=0);this.selectionEnd=this.selectionStart;this._selectionDirection="left"},moveCursorLeft:function(e){if(0!==this.selectionStart||0!==this.selectionEnd)this.abortCursorAnimation(),
this._currentCursorOpacity=1,e.shiftKey?this.moveCursorLeftWithShift(e):this.moveCursorLeftWithoutShift(e),this.initDelayedCursor()},_move:function(e,c,a){this[c]=e.altKey?this["findWordBoundary"+a](this[c]):e.metaKey?this["findLineBoundary"+a](this[c]):this[c]+("Left"===a?-1:1)},_moveLeft:function(e,c){this._move(e,c,"Left")},_moveRight:function(e,c){this._move(e,c,"Right")},moveCursorLeftWithoutShift:function(e){this._selectionDirection="left";this.selectionEnd===this.selectionStart&&this._moveLeft(e,
"selectionStart");this.selectionEnd=this.selectionStart},moveCursorLeftWithShift:function(e){"right"===this._selectionDirection&&this.selectionStart!==this.selectionEnd?this._moveLeft(e,"selectionEnd"):(this._selectionDirection="left",this._moveLeft(e,"selectionStart"),"\n"===this.text.charAt(this.selectionStart)&&this.selectionStart--,0>this.selectionStart&&(this.selectionStart=0))},moveCursorRight:function(e){this.selectionStart>=this.text.length&&this.selectionEnd>=this.text.length||(this.abortCursorAnimation(),
this._currentCursorOpacity=1,e.shiftKey?this.moveCursorRightWithShift(e):this.moveCursorRightWithoutShift(e),this.initDelayedCursor())},moveCursorRightWithShift:function(e){"left"===this._selectionDirection&&this.selectionStart!==this.selectionEnd?this._moveRight(e,"selectionStart"):(this._selectionDirection="right",this._moveRight(e,"selectionEnd"),"\n"===this.text.charAt(this.selectionEnd-1)&&this.selectionEnd++,this.selectionEnd>this.text.length&&(this.selectionEnd=this.text.length))},moveCursorRightWithoutShift:function(e){this._selectionDirection=
"right";this.selectionStart===this.selectionEnd?(this._moveRight(e,"selectionStart"),this.selectionEnd=this.selectionStart):(this.selectionEnd+=this.getNumNewLinesInSelectedText(),this.selectionEnd>this.text.length&&(this.selectionEnd=this.text.length),this.selectionStart=this.selectionEnd)},removeChars:function(e){this.selectionStart===this.selectionEnd?this._removeCharsNearCursor(e):this._removeCharsFromTo(this.selectionStart,this.selectionEnd);this.selectionEnd=this.selectionStart;this._removeExtraneousStyles();
this.canvas&&this.canvas.renderAll().renderAll();this.setCoords();this.fire("changed");this.canvas&&this.canvas.fire("text:changed",{target:this})},_removeCharsNearCursor:function(e){0!==this.selectionStart&&(e.metaKey?(e=this.findLineBoundaryLeft(this.selectionStart),this._removeCharsFromTo(e,this.selectionStart),this.selectionStart=e):e.altKey?(e=this.findWordBoundaryLeft(this.selectionStart),this._removeCharsFromTo(e,this.selectionStart),this.selectionStart=e):(e="\n"===this.text.slice(this.selectionStart-
1,this.selectionStart),this.removeStyleObject(e),this.selectionStart--,this.text=this.text.slice(0,this.selectionStart)+this.text.slice(this.selectionStart+1)))}});
