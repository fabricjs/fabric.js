(function(){
  ...
  test('parseAttributesNoneValues', function() {
    ...
    same({ fill: '', stroke: '' }, fabric.parseAttributes(element, 'fill stroke'.split(' ')));
  });
  ...
  test('parseAttributesFillRule', function() {
    ...
    same({ fillRule: 'destination-over' }, fabric.parseAttributes(element, ['fill-rule']));
  });
  ...
  test('parseAttributesFillRuleWithoutTransformation', function() {
    ...
    same({ fillRule: 'inherit' }, fabric.parseAttributes(element, ['fill-rule']));
  });
  
  test('parseAttributesTransform', function() {
    var element = document.createElement('path');
    element.setAttribute('transform', 'translate(5, 10)');
    same({ transformMatrix: [1, 0, 0, 1, 5, 10] }, fabric.parseAttributes(element, ['transform']));
  });
