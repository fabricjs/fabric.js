...
function SandboxUI({
  ...
  return hidden ? <>{children}</> : <div className="App">
        <header className="App-header my-3">
          ...
          <div className="f1">
            <Button as="a" href="http://fabricjs.com/" target="_blank" rel="noopener noreferrer" variant="link">
              Docs
            </Button>
        ...
        <Button onClick={() => setShowComments(1)} variant="outline-success">
          Show Comments
          <Image src=" https://unpkg.com/ionicons@latest/dist/svg/information-circle-outline.svg" width={24} className="mx-1" />
        </Button>
        <Modal show={showModal === 1} onHide={hideModal} backdrop="static" centered>
          <Modal.Header closeButton>
