(function(){
  ...
  test('parseAttributes', function() {
    ...
    var attributeNames = 'cx cy x y r fill-opacity opacity fill-rule stroke-opacity stroke-width transform fill fill-rule'.split(' ');
