(function() {
  ...
  QUnit.test('initializing with string', function(assert) {
    ...
    let shadow5 = new fabric.Shadow('#000000');
    ...
    let shadow6 = new fabric.Shadow('10px 20px 5px rgba(0,0,255,0.5)');
    ...
    let shadow7 = new fabric.Shadow('10 20 5px #00FF00');
    ...
    let shadow8 = new fabric.Shadow('10px 20px rgb(0,0,255)');
    ...
    let shadow9 = new fabric.Shadow(' 10px #FF0000 ');
    ...
    let shadow10 = new fabric.Shadow('  #FF0000 ');
    ...
    let shadow11 = new fabric.Shadow('');
    ...
    let shadow12 = new fabric.Shadow('#FF0000 0.1px 0.1px 0.28px');
    ...
    let shadow13 = new fabric.Shadow('rgba(0,0,255,0.5) -0.1px -0.1px 0.28px');
    ...
    let shadow14 = new fabric.Shadow('rgba(0,0,255,0.5) -0.1 -0.1 0.77');
    ...
    let shadow15 = new fabric.Shadow('rgba(0,0,255,0.5) 0.1 0.1 1');
  ...
  QUnit.test('clone with affectStroke', function(assert) {
    let shadow = new fabric.Shadow({affectStroke: true, blur: 5});
    assert.ok(typeof shadow.toObject === 'function');
    let object = shadow.toObject(),
  ...
  QUnit.test('toSVG', function(assert) {
    let shadow = new fabric.Shadow({color: '#FF0000', offsetX: 10, offsetY: -10, blur: 2});
    let object = new fabric.Object({fill: '#FF0000'});
  ...
  QUnit.test('toSVG with flipped object', function(assert) {
    let shadow = new fabric.Shadow({color: '#FF0000', offsetX: 10, offsetY: -10, blur: 2});
    let object = new fabric.Object({fill: '#FF0000', flipX: true, flipY: true});
  ...
  QUnit.test('toSVG with rotated object', function(assert) {
    let shadow = new fabric.Shadow({color: '#FF0000', offsetX: 10, offsetY: 10, blur: 2});
    let object = new fabric.Object({fill: '#FF0000', angle: 45});
  ...
  QUnit.test('toSVG with rotated flipped object', function(assert) {
    let shadow = new fabric.Shadow({color: '#FF0000', offsetX: 10, offsetY: 10, blur: 2});
    let object = new fabric.Object({fill: '#FF0000', angle: 45, flipX: true});
