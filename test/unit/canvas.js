(function() {
  ...
  QUnit.test('loadFromJSON with custom properties on Canvas with no async object', function(assert) {
    ...
    assert.equal(canvas.controlsAboveOverlay, canvas.defaultValues.controlsAboveOverlay);
    assert.equal(canvas.preserveObjectStacking, canvas.defaultValues.preserveObjectStacking);
