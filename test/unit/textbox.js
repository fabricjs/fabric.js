(function() {
  ...
  QUnit.test('wrapping with custom space', function(assert) {
    ...
    var line1 = textbox._wrapLine('xa xb xc xd xe ya yb id', 0, 0, 100, 0);
    var expected1 =  [
      ['x', 'a', ' ', 'x', 'b'],
      ['x', 'c', ' ', 'x', 'd'],
      ['x', 'e', ' ', 'y', 'a'],
    ...
    var line2 = textbox._wrapLine('xa xb xc xd xe ya yb id', 0, 0, 100, 50);
    var expected2 =  [
      ['x', 'a'],
      ['x', 'b'],
      ['x', 'c'],
