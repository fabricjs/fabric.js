  ...
  QUnit.module('selection changes', function (hooks) {
    ...
    QUnit.module('Clipboard Events', (hooks) => {
      ...
      QUnit[isNode() ? 'skip' : 'test']('cut', function (assert) {
        ...
        assert.equal(event.clipboardData.getData('text/plain'), 'te', 'it copied first 2 characters');
        assert.equal(event.clipboardData.getData('application/fabric'), '{\"text\":\"te\",\"styles\":[{\"fontSize\":25,\"fontWeight\":\"normal\",\"fontFamily\":\"Times New Roman\",\"fontStyle\":\"normal\",\"underline\":false,\"overline\":false,\"linethrough\":false,\"stroke\":null,\"strokeWidth\":1,\"fill\":\"red\",\"deltaY\":0,\"textBackgroundColor\":\"\"},{\"fontSize\":25,\"fontWeight\":\"normal\",\"fontFamily\":\"Times New Roman\",\"fontStyle\":\"normal\",\"underline\":false,\"overline\":false,\"linethrough\":false,\"stroke\":null,\"strokeWidth\":1,\"fill\":\"blue\",\"deltaY\":0,\"textBackgroundColor\":\"\"}]}');
        assert.ok(fired.length === 1 && fired[0] === event, 'fired cut');
