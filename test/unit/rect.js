(function() {
  ...
  test('toSVG with alpha colors fill', function() {
    var rect = new fabric.Rect({ width: 100, height: 100, fill: 'rgba(255, 0, 0, 0.5)' });
    var svg = rect.toSVG();
    equal(svg, '<rect x="-50" y="-50" rx="0" ry="0" width="100" height="100" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: rgb(255,0,0); fill-opacity: 0.5; fill-rule: nonzero; opacity: 1;" transform="translate(50 50)"/>\n');
  });

  test('toSVG with alpha colors stroke', function() {
    var rect = new fabric.Rect({ width: 100, height: 100, fill: '', stroke: 'rgba(255, 0, 0, 0.5)' });
    var svg = rect.toSVG();
    equal(svg, '<rect x="-50" y="-50" rx="0" ry="0" width="100" height="100" style="stroke: rgb(255, 0, 0); stroke-opacity: 0.5; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: none; fill-rule: nonzero; opacity: 1;" transform="translate(50 50)"/>\n');
  });
