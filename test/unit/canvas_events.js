(function() {
  ...
  QUnit.test('_beforeTransform', function (assert) {
    ...
    let canvasOffset = canvas.calcOffset();
    let rect = new fabric.Rect({ left: 50, top: 50, width: 50, height: 50 });
    canvas.add(rect);
