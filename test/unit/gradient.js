(function() {
  ...
  function fromElement(element, object, options = {}) {
    let gradient;
    fabric.Gradient.fromElement(element, g => (gradient = g), { ...options, object });
    return gradient;
  }
  ...
  QUnit.test('fromElement linearGradient', function(assert) {
    ...
    var gradient = fromElement(element, object, { opacity: '' });
  ...
  QUnit.test('fromElement linearGradient with floats percentage - userSpaceOnUse', function(assert) {
    ...
    var gradient = fromElement(element, object, {
      opacity: '',
      viewBoxWidth: 400,
      viewBoxHeight: 300,
    });
