(function() {
  ...
  let SVG_LINEAR = '<linearGradient id=\"SVGID_0\" gradientUnits=\"userSpaceOnUse\" gradientTransform=\"matrix(1 0 0 1 -50 -50)\"  x1=\"0\" y1=\"10\" x2=\"100\" y2=\"200\">\n<stop offset=\"0%\" style=\"stop-color:red;stop-opacity: 0\"/>\n<stop offset=\"100%\" style=\"stop-color:green;\"/>\n</linearGradient>\n';
  let SVG_RADIAL = '<radialGradient id=\"SVGID_0\" gradientUnits=\"userSpaceOnUse\" gradientTransform=\"matrix(1 0 0 1 -50 -50)\"  cx=\"100\" cy=\"200\" r=\"50\" fx=\"0\" fy=\"10\">\n<stop offset=\"0%\" style=\"stop-color:red;\"/>\n<stop offset=\"100%\" style=\"stop-color:green;stop-opacity: 0\"/>\n</radialGradient>\n';
  let SVG_INTERNALRADIUS = '<radialGradient id=\"SVGID_0\" gradientUnits=\"userSpaceOnUse\" gradientTransform=\"matrix(1 0 0 1 -50 -50)\"  cx=\"100\" cy=\"200\" r=\"50\" fx=\"0\" fy=\"10\">\n<stop offset=\"20%\" style=\"stop-color:red;\"/>\n<stop offset=\"100%\" style=\"stop-color:green;stop-opacity: 0\"/>\n</radialGradient>\n';
  let SVG_SWAPPED = '<radialGradient id=\"SVGID_0\" gradientUnits=\"userSpaceOnUse\" gradientTransform=\"matrix(1 0 0 1 -50 -50)\"  cx=\"0\" cy=\"10\" r=\"50\" fx=\"100\" fy=\"200\">\n<stop offset=\"20%\" style=\"stop-color:green;stop-opacity: 0\"/>\n<stop offset=\"100%\" style=\"stop-color:red;\"/>\n</radialGradient>\n';
  let SVG_LINEAR_PERCENTAGE = '<linearGradient id=\"SVGID_0\" gradientUnits=\"objectBoundingBox\" gradientTransform=\"matrix(1 0 0 1 0 0)\"  x1=\"0\" y1=\"10\" x2=\"100\" y2=\"200\">\n<stop offset=\"0%\" style=\"stop-color:red;stop-opacity: 0\"/>\n<stop offset=\"100%\" style=\"stop-color:green;\"/>\n</linearGradient>\n';
  let SVG_RADIAL_PERCENTAGE = '<radialGradient id=\"SVGID_0\" gradientUnits=\"objectBoundingBox\" gradientTransform=\"matrix(1 0 0 1 0 0)\"  cx=\"100\" cy=\"200\" r=\"50\" fx=\"0\" fy=\"10\">\n<stop offset=\"0%\" style=\"stop-color:red;\"/>\n<stop offset=\"100%\" style=\"stop-color:green;stop-opacity: 0\"/>\n</radialGradient>\n';
  ...
  QUnit.test('fromElement linearGradient', function(assert) {
    ...
    var element = fabric.getFabricDocument().createElementNS(namespace, 'linearGradient');
    var stop1 = fabric.getFabricDocument().createElement('stop');
    var stop2 = fabric.getFabricDocument().createElement('stop');
  ...
  QUnit.test('fromElement linearGradient with Infinity', function(assert) {
    ...
    var namespace = 'http://www.w3.org/2000/svg';
    var element = fabric.getFabricDocument().createElementNS(namespace, 'linearGradient');
    var stop1 = fabric.getFabricDocument().createElementNS(namespace, 'stop');
    var stop2 = fabric.getFabricDocument().createElementNS(namespace, 'stop');
  ...
  QUnit.test('fromElement with x1,x2,y1,2 linear', function(assert) {
    ...
    gradient = fabric.Gradient.fromElement(element, object, { opacity: '' });
  ...
  QUnit.test('fromElement with x1,x2,y1,2 radial', function(assert) {
    ...
    var namespace = 'http://www.w3.org/2000/svg';
    var element = fabric.getFabricDocument().createElementNS(namespace, 'radialGradient');
  ...
  QUnit.test('fromElement linearGradient colorStop attributes/styles', function(assert) {
    ...
    var stop1 = fabric.getFabricDocument().createElementNS(namespace, 'stop');
    var stop2 = fabric.getFabricDocument().createElementNS(namespace, 'stop');
    var stop3 = fabric.getFabricDocument().createElementNS(namespace, 'stop');
    var stop4 = fabric.getFabricDocument().createElementNS(namespace, 'stop');
