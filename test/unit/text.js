(function () {
  ...
  QUnit.test('getFontDeclaration', function (assert) {
    ...
    var actualDeclaration = text._getFontDeclaration(styleObject);

    assert.equal(actualDeclaration, expectedDeclaration, 'Font declaration is correct');
  });
