    ...
    [true, false].forEach(function(val) {
      QUnit.module('fabric.BaseBrush with canvas.enableRetinaScaling = ' + val, function(hooks) {
        ...
        QUnit.test('fabric pencil brush draw point', function(assert) {
          ...
          var pointer = canvas.getCanvasPointFromEvent({ ...e, clientX: 10, clientY: 10 });
        ...
        QUnit.test('fabric pencil brush multiple points not discarded', function(assert) {
          ...
          const e = { target: canvas.upperCanvasEl };
          var pointer = canvas.getCanvasPointFromEvent({ ...e, clientX: 10, clientY: 10});
          var pointer2 = canvas.getCanvasPointFromEvent({ ...e, clientX: 15, clientY: 15});
          var pointer3 = canvas.getCanvasPointFromEvent({ ...e, clientX: 20, clientY: 20});
          brush.onMouseDown(pointer, { e });
        ...
        QUnit.test('fabric pencil brush multiple points outside canvas', function(assert) {
          ...
          const e = { target: canvas.upperCanvasEl };
          var pointer = canvas.getCanvasPointFromEvent({ ...e, clientX: 10, clientY: 10});
          var pointer2 = canvas.getCanvasPointFromEvent({ ...e, clientX: 15, clientY: 100});
          var pointer3 = canvas.getCanvasPointFromEvent({ ...e, clientX: 20, clientY: 160});
          var pointer4 = canvas.getCanvasPointFromEvent({ ...e, clientX: 320, clientY: 100});
          var pointer5 = canvas.getCanvasPointFromEvent({ ...e, clientX: 100, clientY: 100});
          brush.onMouseDown(pointer, { e });
          brush.onMouseMove(pointer2, { e });
          brush.onMouseMove(pointer3, { e });
