import { HorizontalLineProps, VerticalLineProps } from "../@types";
...
export function makeVerticalLine(props: VerticalLineProps) {
    ...
    return {
        x,
        y1: b ? objectY - objectHeight / 2 - aligningLineOffset : objectY + objectHeight / 2 + aligningLineOffset,
        y2: b
...
export function makeHorizontalLine(props: HorizontalLineProps) {
    ...
    return {
        y,
        x1: b ? objectX - objectWidth / 2 - aligningLineOffset : objectX + objectWidth / 2 + aligningLineOffset,
        x2: b
