...
(function (global) {
  ...
  function getPointer(event) {
    ...
    var o = { x: pointerX(event), y: pointerY(event) };
    console.log(o.x + ' ' + event.pageX + ' ' + event.clientX);
    return o;
  }
  ...
  var InteractiveMethods = /** @scope fabric.Canvas.prototype */ {
    ...
    _initEvents: function () {
      ...
      this._onMouseDown = function (e) {
        //console.log('before mousedown ' + (canvas.item(0) && canvas.item(0).left));
        _this.__onMouseDown(e);
        //console.log('after mousedown ' + (canvas.item(0) && canvas.item(0).left));
      ...
      this._onMouseUp = function (e) {
        //console.log('before mouseup ' + (canvas.item(0) && canvas.item(0).left));
    ...
    __onMouseUp: function (e) {
      //console.log('mouseup ' + (canvas.item(0) && canvas.item(0).left));
    ...
    __onMouseDown: function (e) {
      //console.log('mousedown ' + (canvas.item(0) && canvas.item(0).left));
      ...
      //console.log('mousedown 2 ' + (canvas.item(0) && canvas.item(0).left));
    },
    ...
    __onMouseMove: function (e) {
      // console.log('mousemove ' + (canvas.item(0) && canvas.item(0).left));
    ...
    _translateObject: function (x, y) {
      //console.log('translateObject' + (canvas.item(0) && canvas.item(0).left));
...
(function(global) {
  ...
  fabric.Object = fabric.util.createClass(/** @scope fabric.Object.prototype */ {
    ...
    set: function(property, value) {
      ...
      //console.log('setting value ' + property + ' ' + value);
    ...
    toDataURL: function(callback) {
      ...
      function proceed(clone) {
        console.log('setting left in proceed');
...
(function(global) {
  ...
  function _setDefaultLeftTopValues(attributes) {
    console.log('setting default left top values');
...
(function(global) {
  ...
  fabric.PathGroup = fabric.util.createClass(fabric.Path, /** @scope fabric.PathGroup.prototype */ {
    ...
    set: function(prop, value) {
      ...
      // if (isNaN(value) && value !== value) return this;
...
(function(global){
  ...
  fabric.Group = fabric.util.createClass(fabric.Object, /** @scope fabric.Group.prototype */ {
    ...
    _updateObjectsCoords: function() {
      //console.log('updating object coords' + (canvas.item(0) && canvas.item(0).left));
