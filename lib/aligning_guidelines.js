  ...
  canvas.on('object:moving', function(e) {
    ...
    for (var i = canvasObjects.length; i--; ) {
      ...
      if (isInRange(objectLeft, activeObjectLeft)) {
        ...
        activeObject.setRelativeXY(new fabric.Point(objectLeft, activeObjectTop), 'center', 'center');
      }
      ...
      if (isInRange(objectLeft - objectWidth / 2, activeObjectLeft - activeObjectWidth / 2)) {
        ...
        activeObject.setRelativeXY(new fabric.Point(objectLeft - objectWidth / 2 + activeObjectWidth / 2, activeObjectTop), 'center', 'center');
      }
